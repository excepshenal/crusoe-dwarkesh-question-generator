...
| **1 — prompting** | *iterating.* qwen3-235b, Method B: v0 = 14.7% → **v1 = 29.7% win-rate vs Dwarkesh** (held-out, n=60, frozen GLM judge) after an anti-"syllogism" prompt edit. See `evals/results.md`. |
| **2 — SFT** | not started. |
