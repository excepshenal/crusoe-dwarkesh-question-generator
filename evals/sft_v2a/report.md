...
**Win-rate 38%**  (n=60: 19 win / 8 tie / 33 loss). Each card: the tool's question vs the reference, and why the judge picked one. (Judged in both A/B orders; a disagreement across orders = tie.)

> **sft_v2 = prod finetuning-job ckpt-48 — a different recipe from v0/v1** (prod stack, LoRA r=16/α=32
> vs run1/2's r=32/α=64, and trained on the **8k-len filtered data** that drops rows over the
> 7447-token cap). This is **temp 0, greedy**: 3-pass mean **37.8% ± 0.8%** — the best greedy of any
> SFT run (v0a 27.5%, v1a 33.9%). Decoding siblings: [`sft_v2b`](../sft_v2b/report.md) (rep_penalty
> 1.1) = **45.0%** (best), [`sft_v2c`](../sft_v2c/report.md) (temp 0.7) = 37.2%. Length-filtering cut
> runaways (10% here vs v0a's 20%) but **not** the no-question rate (40% — highest yet): "emits a
> statement, not a question" is orthogonal to length. See results.md.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I’m curious about the Y chromosome and the mitochondrial DNA. I understand that the Y chromosome is passed down from father to son, and the mitochondrial DNA is passed down from mother to daughter. But why is it that the Y chromosome and the mitochondrial DNA are so much more similar between Neanderthals and modern humans than the rest of the genome?
...
> Candidate A asks about something the guest just explained (interbreeding 200-300kya caused the Y chromosome and mtDNA similarity), while B naturally probes the core puzzle the guest is obsessed with—what's actually driving that shared connection between Neanderthals and modern humans.
> Candidate B asks about something Reich already explained (the Y chromosome and mtDNA similarity came from interbreeding 200-300kya), while A pushes the conversation forward by asking what kind of hidden connection could resolve the puzzle Reich is obsessed with.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** Okay, so what would you do? What would you do to make it possible?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is too vague and slightly contradicts what the guest just said (he claimed the technology already exists); Candidate B references a real engineering challenge that creates genuine tension with the claim and will yield a specific, interesting answer.
> Candidate A references the guest's own writing and a specific technical challenge (lateral forces), giving Potter a concrete entry point to explain how the technology actually overcomes those forces—whereas Candidate B's generic 'what would you do to make it possible?' risks a flat answer since Pott
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** Yeah. I think it's good to have that awareness.
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is merely agreeing with the guest and adds no question or new angle, while Candidate B asks a genuinely curious, specific question that Grant Sanderson is well-positioned to answer and connects thematically to the discussion of intellectual bounds.
> Candidate B is merely an agreement that adds nothing and goes nowhere, while Candidate A, despite being a somewhat abrupt pivot, at least poses a genuine question that could spark interesting discussion about the practical relevance of foundational limits.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** But the Tsar has a secret police.

**Reference (Dwarkesh):** Didn't you say that in 1928 he had like one bodyguard when he would go to his dacha?

**Judge:** tool **LOSS** — order1 B, order2 A
> B uses a specific detail from earlier in the conversation to push back on Kotkin's claim, creating genuine tension with his own prior statements, whereas A makes a generic counter-point that doesn't engage the conversation as sharply.
> Candidate A uses the guest's own prior statement to push back on his claim, creating a sharper and harder-to-evade tension than the more generic point about the Tsar's secret police.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I want to talk about the geopolitical implications of oil. One thing that really struck me is that the British Royal Navy was the first to convert to oil. Why was that the case?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> B stays with the thread about Rockefeller's unpopularity and asks a genuinely curious, natural follow-up — could the PR have been managed better? — while A pivots away to a prepared-sounding question about the British Navy that ignores the rich discussion just happening about antitrust and public se
> Candidate A naturally follows up on the PR/political hatred thread just discussed, while Candidate B abruptly pivots to an unrelated topic and signals the asker's knowledge rather than genuine curiosity about the current conversation.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I guess the other thing is that the peasants are not really organized. They're not organized in a way that they can overthrow the regime. They're not organized in a way that they can even have a strike. They're not organized in a way that they can have a revolt. They're just individual peasants who are trying to get their land.
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is barely a question—it's a flat assertion about peasant disorganization that adds no new angle; Candidate B asks the genuinely urgent question at the heart of the topic—why the surplus of sadism among ordinary participants—which the guest hasn't addressed and any curious listener would 
> Candidate A directly engages the interview's core question—why so many participated in the horrors—by asking something genuinely curious about human nature vs. circumstance, while Candidate B is more of an obvious assertion than a question and adds little new.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I guess the reason I'm asking is, if you think about the world in terms of the holographic principle, then you're thinking about the world in terms of the boundary. And if you think about the world in terms of the boundary, then you're thinking about the world in terms of the information that is on the boundary.

And if you think about the world in terms of the information that is on the boundary, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole.

And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on the horizon of a black hole. And if you think about the world in terms of the information that is on the horizon of a black hole, then you're thinking about the world in terms of the information that is on
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a broken repetitive loop; Candidate B asks a genuinely curious follow-up about the physical reality question and makes a worthwhile pivot to de Sitter space, which is the obvious next question since AdS/CFT applies to anti-de Sitter space, not our universe.
> Candidate B is a broken repetitive loop that adds nothing, while Candidate A asks a genuinely curious follow-up about the physical 'location' of these dual descriptions and makes a worthwhile pivot to de Sitter space, which is our actual universe.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I want to ask you about the “country of geniuses in the data center” world. I’m curious about what you think the world looks like in that world. I’m curious about what you think the world looks like in the world where we have the “country of geniuses in the data center” and we’ve solved the safety problems.
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a generic softball asking Dario to describe a future he's already written an essay about; Candidate B asks a specific, genuinely curious follow-up about whether robotics gets solved quickly in that world, with a concrete reasoning angle about teleoperation that builds naturally on the
> Candidate A asks a specific, concrete question about whether robotics gets solved quickly post-AGI, while Candidate B is a generic softball ('what does the world look like?') that could be asked of anyone and has awkwardly repetitive phrasing.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I guess I'm asking why there hasn't been a similar sort of transformation in the way that people learn math. I guess you're saying that there has been but it's just not as visible because it's not as easy to recommend.
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A merely parrots back what Grant just said and confirms understanding, adding no new angle, while Candidate B asks a genuinely curious and specific follow-up question about whether top educators should shift to internet-scale teaching given the reach advantage discussed.
> Candidate B merely paraphrases what Grant just said and confirms understanding, adding no new angle, while Candidate A introduces a genuinely new and interesting question about whether top educators should prioritize internet scale over traditional teaching.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** Yeah, I think that's right. I think that's a good point.
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is not a question at all—just agreement that goes nowhere—while B, though a sharp pivot, poses a genuinely curious question well-suited to a math educator and likely to yield interesting discussion.
> Candidate B isn't a question at all—it's just agreement that goes nowhere—while A, despite being an abrupt pivot, at least asks a genuinely curious question that could spark an interesting discussion about math and human cognition.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I want to ask you about the book. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think you'll find interesting. I'm going to ask you about the book in a way that I think
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a garbled repetitive loop and not a real question; Candidate B asks a specific, genuinely curious question referencing Byrne's actual writing about talent scouting and parental involvement.
> Candidate B is broken text repeating the same phrase endlessly; Candidate A asks a specific, genuinely curious question about talent scouting that references Byrne's own writing and introduces a new angle on signaling.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** But it seems like we have a pretty good understanding of how many GPUs you need to get to GPT-5. And we have a pretty good understanding of how many GPUs you need to get to GPT-6. And we have a pretty good understanding of how many GPUs you need to get to GPT-7. And we have a pretty good understanding of how many GPUs you need to get to GPT-8. And we have a pretty good understanding of how many GPUs you need to get to GPT-9. And we have a pretty good understanding of how many GPUs you need to get to GPT-10. And we have a pretty good understanding of how many GPUs you need to get to GPT-11. And we have a pretty good understanding of how many GPUs you need to get to GPT-12. And we have a pretty good understanding of how many GPUs you need to get to GPT-13. And we have a pretty good understanding of how many GPUs you need to get to GPT-14. And we have a pretty good understanding of how many GPUs you need to get to GPT-15. And we have a pretty good understanding of how many GPUs you need to get to GPT-16. And we have a pretty good understanding of how many GPUs you need to get to GPT-17. And we have a pretty good understanding of how many GPUs you need to get to GPT-18. And we have a pretty good understanding of how many GPUs you need to get to GPT-19. And we have a pretty good understanding of how many GPUs you need to get to GPT-20. And we have a pretty good understanding of how many GPUs you need to get to GPT-21. And we have a pretty good understanding of how many GPUs you need to get to GPT-22. And we have a pretty good understanding of how many GPUs you need to get to GPT-23. And we have a pretty good understanding of how many GPUs you need to get to GPT-24. And we have a pretty good understanding of how many GPUs you need to get to GPT-25. And we have a pretty good understanding of how many GPUs you need to get to GPT-26. And we have a pretty good understanding of how many GPUs you need to get to GPT-27. And we have a pretty good understanding of how many GPUs you need to get to GPT-28. And we have a pretty good understanding of how many GPUs you need to get to GPT-29. And we have a pretty good understanding of how many GPUs you need to get to GPT-30. And we have a pretty good understanding of how many GPUs you need to get to GPT-31. And we have a pretty good understanding of how many GPUs you need to get to GPT-32. And we have a pretty good understanding of how many GPUs you need to get to GPT-33. And we have a pretty good understanding of how many GPUs you need to get to GPT-34. And we have a pretty good understanding of how many GPUs you need to get to GPT-35. And we have a pretty good understanding of how many GPUs you need to get to GPT-36. And we have a pretty good understanding of how many GPUs you need to get to GPT-37. And we have a pretty good understanding of how many GPUs you need to get to GPT-38. And we have a pretty good understanding of how many GPUs you need to get to GPT-39. And we have a pretty good understanding of how many GPUs you need to get to GPT-40. And we have a pretty good understanding of how many GPUs you need to get to GPT-41. And we have a pretty good understanding of how many GPUs you need to get to GPT-42. And we have a pretty good understanding of how many GPUs you need to get to GPT-43. And we have a pretty good understanding of how many GPUs you need to get to GPT-44. And we have a pretty good understanding of how many GPUs you need to get to GPT-45. And we have a pretty good understanding of how many GPUs you need to get to GPT-46. And we have a pretty good understanding of how many GPUs you need to get to GPT-47. And we have a pretty good understanding of how many GPUs you need to get to GPT-48. And we have a pretty good understanding of how many GPUs you need to get to GPT-49. And we have a pretty good understanding of how many GPUs you need to get to GPT-50. And we have a pretty good understanding of how many GPUs you need to
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a joke response that repeats the same sentence 50 times and is not a real question; Candidate B is a short, direct, genuinely curious question that presses Yudkowsky for concreteness on what level of regulation would actually reduce his doom estimate, which naturally follows the discu
> Candidate B is disqualified — it's an absurdly repetitive list that stacks the same clause dozens of times, making it convoluted and unaskable; Candidate A is short, direct, and genuinely curious, pressing Yudkowsky to specify what level of regulation would actually reduce his p(doom).
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I want to ask you about the future of education. I think you’re right that the future of education is AI plus human. But I want to ask you about the human part. What is the role of the human in this future?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> B follows the actual thread of conversation—how to learn when you lack a conversational explainer—while A abandons the interesting discussion about communication and explanation to ask a generic softball about 'the role of the human in education.'
> Candidate A follows naturally from the conversation about the gap between formal and conversational explanation, asking a specific practical question about learning strategies; Candidate B is a generic softball that ignores what was just discussed and could be asked of anyone.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I want to ask you about the downstream. I think you’ve been very clear about the upstream. You’ve been very clear about the downstream. You’ve been very clear about the software. You’ve been very clear about the architecture. You’ve been very clear about the systems. You’ve been very clear about the networking. You’ve been very clear about the supply chain. You’ve been very clear about the ecosystem. You’ve been very clear about the demand. You’ve been very clear about the moat. You’ve been very clear about the future. You’ve been very clear about the past. You’ve been very clear about the present. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been very clear about the future. You’ve been
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a degenerate repetition and not a real question; Candidate B is a short, specific, genuinely curious question directly relevant to the episode's core topic about TPUs and Nvidia's competitive position.
> Candidate A is a short, specific question directly on the interview's core topic (TPUs vs Nvidia), while Candidate B is garbled repetitive text.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I'm curious about the role of the media in this. I think the media is a place where you can get recognition and you can get a lot of influence. I think it's a place where you can get a lot of thumos. I think it's a place where you can get a lot of power. I think it's a place where you can get a lot of money. I think it's a place where you can get a lot of status. I think it's a place where you can get a lot of fame. I think it's a place where you can get a lot of influence. I think it's a place where you can get a lot of power. I think it's a place where you can get a lot of money. I think it's a place where you can get a lot of status. I think it's a place where you can get a lot of fame. I think it's a place where you can get a lot of influence. I think it's a place where you can get a lot of power. I think it's a place where you can get a lot of money. I think it's a place where you can get a lot of status. I think it's a place where you can get a lot of fame. I think it's a place where you can get a lot of influence. I think it's a place where you can get a lot of power. I think it's a place where you can get a lot of money. I think it's a place where you can get a lot of status. I think it's a place where you can get a lot of fame. I think it's a place where you can get a lot of influence. I think it's a place where you can get a lot of power. I think it's a place where you can get a lot of money. I think it's a place where you can get a lot of status. I think it's a place where you can get a lot of fame. I think it's a place where you can get a lot of influence. I think it's a place where you can get a lot of power. I think it's a place where you can get a lot of money. I think it's a place where you can get a lot of status. I think it's a place where you can get a lot of fame. I think it's a place where you can get a lot of influence. I think it's a place where you can get a lot of power. I think it's a place where you can get a lot of money. I think it's a place where you can get a lot of status. I think it's a place where you can get a lot of fame. I think it's a place where you can get a lot of influence. I think it's a place where you can get a lot of power. I think it's a place where you can get a lot of money. I think it's a place where you can get a lot of status. I think it's a place where you can get a lot of fame. I think it's a place where you can get a lot of influence. I think it's a place where you can get a lot of power. I think it's a place where you can get a lot of money. I think it's a place where you can get a lot of status. I think it's a place where you can get a lot of fame. I think it's a place where you can get a lot of influence. I think it's a place where you can get a lot of power. I think it's a place where you can get a lot of money. I think it's a place where you can get a lot of status. I think it's a place where you can get a lot of fame. I think it's a place where you can get a lot of influence. I think it's a place where you can get a lot of power. I think it's a place where you can get a lot of money. I think it's a place where you can get a lot of status. I think it's a place where you can get a lot of fame. I think it's a place where you can get a lot of influence. I think it's a place where you can get a lot of power. I think it's a place where you can get a lot of money. I think it's a place where you can get a lot of status. I think it's a place where you can get a lot of fame. I think it's a place where you can get a lot of influence. I think it's a place where you can get a lot of power. I think it's a place where you can get a lot of money. I think it's a place where you can get a lot of status. I think it's a place where you can get a lot of fame. I think it's a place where you can get a lot of influence
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a broken output repeating the same phrases in an endless loop, while Candidate B connects a specific point Byrne made earlier to his actual work (The Diff) and asks a genuine, specific question about his approach.
> Candidate B is a malfunctioning output that loops the same phrases endlessly; Candidate A, while somewhat elaborate, references a specific prior point the guest made and asks a genuinely curious connecting question about The Diff's approach.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I’m curious about the way you think about the progress of AI in math. You’ve been a mathematician for decades. You’ve seen the progress of math over decades. You’ve seen the progress of AI over decades. How do you think about the progress of AI in math? Is it like the progress of math? Is it like the progress of AI? Is it like the progress of some other field?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a generic softball that could be asked of anyone; Candidate B asks a specific, concrete follow-up that builds on Tao's point about experimental math and scaling — the question about how much progress comes from simply applying existing techniques to open problems is genuinely interest
> Candidate A asks a specific, genuinely interesting question about the overhang of existing techniques in math that follows directly from Tao's point about experimental math at scale, while Candidate B is a generic softball that could be asked of anyone.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I want to ask you about the prophets and the wizards in the context of the Green Revolution. So the Green Revolution is a great example of the wizard worldview. You have Norman Borlaug, who is the father of the Green Revolution, and he's the wizard. He's the guy who's like “I'm going to use science and technology to increase the carrying capacity of the planet.” And then you have William Vogt, who is the prophet. He's the guy who's like “No, no, we're going to hit the carrying capacity of the planet. We're going to have a Malthusian catastrophe.” So what happened? The Green Revolution happened. The carrying capacity of the planet increased. The prophets were wrong. The wizards were right. So why do you think the prophets are still relevant?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> B asks a specific, genuinely interesting counterfactual question about contingency in innovation that Mann would have a real opinion on given his deep research on Borlaug, whereas A asks a somewhat generic question based on a reductive premise (that prophets were simply 'wrong') that Mann has likely
> Candidate A raises a genuine intellectual debate about contingency vs. convergence in technological progress, directly relevant to Mann's work on Borlaug, while Candidate B misrepresents the book's thesis by framing it as 'wizards were right, prophets were wrong' and then asks a softball question wi
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I’m curious about the timeline of the benefits you’re expecting. You mentioned in “Machines of Loving Grace” that you expect the compressed 21st century to happen in the next five to 10 years. I’m curious about the timeline of the dangers you’re expecting. Is it the same timeline? Is it earlier? Is it later?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> B directly challenges Amodei's stated position on export controls by returning to the interview's core question—why can't both countries have this capability?—while A pivots away to a generic timelines question that doesn't engage what was just said.
> A directly tackles the core question of the interview that hasn't been explicitly posed yet, naturally pushing back on Dario's export controls stance with a short, genuinely curious challenge; B pivots away from the active thread about China/developing world to ask a generic timeline question that n
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I want to ask about the other competitors. AMD has the MI300X, which has more memory than the H100. What is the advantage of the H100?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> B directly challenges Jensen's core claim about CUDA being the moat by pointing out that his biggest customers (hyperscalers) can and do write their own kernels, creating a genuine tension that demands a substantive answer; A is a generic competitor-comparison softball.
> Candidate A raises a genuine, substantive counterpoint to Jensen's claim that CUDA is the fundamental moat—hyperscalers writing their own kernels and using Triton—whereas B pivots to a generic product comparison that could be asked in any interview.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I'm curious about the 1973 oil crisis. I'm curious about the 1979 oil crisis. I'm curious about the 1980s oil crisis. What is the difference between these three crises?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate B asks a specific, genuinely curious question about the mechanics of the 1973 crisis that follows naturally from the conversation, whereas A is vague and repetitive, asking for a broad comparison of three crises without any specific angle.
> Candidate A identifies a specific, genuine puzzle (small supply drop, huge effect) that invites a revealing answer, while Candidate B stacks three crises into a vague 'what's the difference' question that would likely produce an unfocused lecture.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I want to ask you about the future of payments. I'm curious about the future of payments in the context of AI. I'm curious about the future of payments in the context of crypto. I'm curious about the future of payments in the context of the internet. I'm curious about the future of payments in the context of the world. So let's start with AI. What does the future of payments look like in the context of AI?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a rambling, generic 'future of payments' softball that could be asked of anyone; Candidate B is specific, grounded in Stripe's actual product evolution, and asks a genuinely interesting strategic question only Patrick can answer.
> Candidate A asks a specific, genuinely curious question about business complements grounded in Stripe's actual product history, while Candidate B is a generic softball that stacks repetitive clauses and asks a vague question anyone could pose to any payments executive.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I'm curious, what is the reason that the scientists who were working on the bomb didn't see the implications of the bomb? I mean, they were the ones who were working on it. They were the ones who were thinking about the physics of it. They were the ones who were thinking about the engineering of it. They were the ones who were thinking about the implications of it. And yet, they didn't see the implications of it. Why?

**Reference (Dwarkesh):** When you were interviewing the scientists, how many of them did you feel regretted their work?

**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is convoluted, repetitive, and mischaracterizes what Rhodes just said (he didn't say they didn't see implications—he said they weren't interested in projecting the future), while Candidate B asks a simple, genuinely curious question about a new angle (scientists' regret) that hasn't been
> Candidate B is convoluted with repetitive clause-stacking and mischaracterizes the discussion (some scientists DID see it coming, which was the premise of the question), while A is a short, clear question that opens a genuine new line of discussion about the scientists' emotional relationship to the
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I want to ask you about the future of the AI industry. I think there’s a lot of skepticism about whether there will be a single dominant company. I think there’s a lot of skepticism about whether there will be a single dominant model. I think there’s a lot of skepticism about whether there will be a single dominant API.

I think there’s a lot of skepticism about whether there will be a single dominant company. I think there’s a lot of skepticism about whether there will be a single dominant model. I think there’s a lot of skepticism about whether there will be a single dominant API.
...
I think there’s a lot of skepticism about whether there will be a single dominant company. I think there’s a lot of skepticism about whether there will be a single dominant model. I think there
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a garbled repetitive loop and even its single iteration is a generic softball about industry dominance; Candidate B asks a specific, genuinely curious question about a stable equilibrium in a world of diffused and potentially misaligned AIs, which directly engages the regulation/safet
> Candidate B is clearly garbled output repeating the same sentence in an infinite loop, while Candidate A asks a substantive (if somewhat elaborate) question about alignment equilibrium in a world of diffused AI capabilities.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** Okay, so let's talk about the first question. Why is it that modern architecture is so much uglier than the older architecture?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A parrots the topic already discussed at length without adding a new angle, while B asks a genuinely curious, specific follow-up about a technical detail (heat loss through glass) that the guest mentioned but left unexplained.
> Candidate A asks a specific, genuinely curious follow-up about a technical detail the guest just mentioned (how insulation interacts with glass buildings), while Candidate B asks a broad generic question that would mostly rehash what they've already been discussing.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I'm curious to get your take on the fact that the Japanese military, in the 1930s, is not just a military, but it's a political force. It's a political force that is able to assassinate the prime minister. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government to do things that the government doesn't want to do. It's a political force that is able to push the government
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is disqualified due to a severe repetition bug that renders it incoherent; Candidate B, while somewhat name-droppy, asks a genuine comparative question about why top-down reform worked in Japan but not Russia.
> Candidate B is disqualified due to extreme repetition (a clear generation glitch), while Candidate A asks a specific, genuinely curious comparative question about why top-down modernization succeeded in Meiji Japan but failed in Russia, connecting to the conversation's broader theme.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I’m curious about the timeline of human intelligence enhancement. I think you’re right that it’s not going to be the timeline that we would want. But if you look at the timeline of AI, it’s been a lot faster than people expected. And if you look at the timeline of human intelligence enhancement, it’s been a lot slower than people expected. So why do you think that human intelligence enhancement will be faster than people expect?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A mischaracterizes Yudkowsky's position—he called human enhancement a 'Hail Mary pass' and explicitly said genetic engineering won't work on the needed timeline, so asking why he thinks it'll be 'faster than expected' argues against a strawman. Candidate B uses the human enhancement discus
> Candidate B mischaracterizes what Yudkowsky just said—he called human enhancement a Hail Mary pass, not something that would be faster than expected—while Candidate A asks a genuinely interesting question about the Orthogonality Thesis that connects to Yudkowsky's core ideas and would produce a subs
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I'm still curious about what the technical problems are. I'm not sure what the alignment problems are. I'm not sure what the misuse problems are. I'm not sure what the treacherous turn problems are. I'm not sure what the problems are.
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is vague and repetitive (asking 'what are the problems' four times without specificity), while B asks a concrete, genuinely important follow-up: what would actually count as proof or evidence that alignment is solved, which directly probes the verification problem implicit in John's clai
> Candidate A asks a specific, natural follow-up about what evidence of alignment would look like, directly building on John's claim about solving technical alignment problems; Candidate B is vague, repetitive, and asks a generic question that could be posed at any point in the conversation.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I want to ask about the Indo-Anatolian homeland. I’m not sure if I’m pronouncing that right.
...
**Judge:** tool **LOSS** — order1 B, order2 A
> B follows up directly on Reich's point about genetic divergence times, asking a concrete question that probes the architecture of when key differences actually emerged, while A abandons the fascinating thread Reich just opened to pivot to an unrelated topic.
> Candidate A follows up directly on Reich's point about genetic divergence at different time depths, asking a specific and answerable question about fixed differences, while Candidate B is a jarring pivot to an unrelated linguistics topic.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I’m curious about the analogy to the Copernican revolution. In the Copernican revolution, there was a new theory that was more accurate than the old theory. In the case of AI, it’s not that there’s a new theory that’s more accurate than the old theory. It’s that there’s a new kind of intelligence that is better at some tasks than the old kind of intelligence.

So what is the analogy to the Copernican revolution? Is it that we’re realizing that there’s a new kind of intelligence that is better at some tasks than the old kind of intelligence? Or is it that we’re realizing that there’s a new kind of intelligence that is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that this new kind of intelligence is better at some tasks than the old kind of intelligence, and that
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is clearly broken with a repetitive loop that renders it incoherent, while Candidate B builds on Tao's point about Darwin with a genuinely interesting historical observation and connects it back to the earlier thread about verification bottlenecks and tight data loops.
> Candidate B is clearly broken with a repetitive generation error, while Candidate A builds a genuine historical argument from Tao's Darwin reference and asks a substantive, curious question about whether domains with tight verification loops will see more progress.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I'm curious about the relationship between you and John. You guys are co-founders, you're brothers, you're both CEOs. How do you think about the relationship? How do you think about the division of labor? How do you think about the relationship between the two of you?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate B offers a specific, genuinely curious angle (the marriage analogy) that naturally follows the discussion about intense long-term partnerships, whereas Candidate A is a generic co-founder question that could be asked of any pair.
> Candidate A offers a creative, specific analogy that builds on the partnership theme in a genuinely curious way, while Candidate B is a generic, clause-stacked question that could be asked of any co-founder pair and repeats itself.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I'm curious about the way you think about the future. I think you have a very interesting perspective on the future. I'm curious about how you think about the future in general. I'm curious about how you think about the future in the context of the book. I'm curious about how you think about the future in the context of the newsletter. I'm curious about how you think about the future in the context of your investments. I'm curious about how you think about the future in the context of your personal life. I'm curious about how you think about the future in the context of your writing. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast. I'm curious about how you think about the future in the context of your podcast.
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a broken, repetitive output that disqualifies itself; Candidate B asks a specific, answerable question that builds on the guest's known writing about Fukuyama and naturally extends the conversation about personal vs institutional legitimacy.
> Candidate B is a broken, repetitive output that loops the same phrase dozens of times; Candidate A, while elaborate, engages substantively with the conversation's themes about legitimacy and institutional vs. personal rule through a relevant Fukuyama reference and asks a specific, answerable questio
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I guess the question is, what is the equivalent of the nuclear warheads in the biotech world? What is the thing that we should be worried about? Is it the mirror life? Is it the synthetic viruses? Is it the gene drives? What is the thing that we should be worried about?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> B picks up on the nuclear analogy but identifies a genuine, specific tension—biology is inherently dual-use and we *want* it to advance, unlike nukes—making Church's 'nip it in the bud' framing much harder, whereas A is a generic 'what should we worry about?' softball.
> A smartly identifies a genuine tension in Church's own nuclear analogy—biotech is inherently dual-use and we want it to advance, unlike nukes—forcing him to grapple with whether 'nipping it in the bud' even makes sense; B is a generic 'what should we worry about?' softball that any biosecurity guest
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I want to ask you about the Sutton perspective. I think you’ve been very critical of the RL approach. I think you’ve been very critical of the Atari deep-RL approach. I think you’ve been very critical of the idea that the crux of intelligence is animal intelligence. I want to ask you about the Sutton perspective.

I think the way he would put it is that the crux of intelligence is the ability to learn from experience. The way you would put it is that the crux of intelligence is the ability to learn from imitation. I want to ask you about the Sutton perspective.

**Reference (Dwarkesh):** Can you identify the key bottleneck that’s preventing this kind of collaboration between LLMs?

**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is convoluted, stacks claims without a clear question, and seems to show off rather than engage with what Karpathy just said; Candidate B is short, direct, and naturally follows up on his point that these multi-agent approaches haven't happened yet.
> Candidate A is short, direct, and naturally curious about what's holding back the multi-agent/self-play paradigm Karpathy just described, while Candidate B is convoluted, repetitive, and seems to manufacture a tension (imitation vs experience) that Karpathy didn't actually articulate.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I want to ask you about the Wizard and the Prophet. I think you're a Wizard, right?
...
> Candidate A is short, genuinely curious, and makes a natural pivot to another of Mann's major works with a personal hook; Candidate B is a convoluted, clause-stacking question that asks Mann to explain a complex historical puzzle on the spot and puts words in his mouth.
> Candidate A asks a genuinely curious, specific question about a real puzzle from Mann's work—why certain seemingly inevitable technologies didn't emerge in the Americas—while Candidate B is a softball label-confirmation that goes nowhere.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I want to go back to the point about instrumental convergence. I'm curious how you think about this. I'm not sure if you've thought about this in the context of RLHF.

If you're training a model to produce a high quality output, it might have an instrumental goal to take over the world. It might have an instrumental goal to get more compute. It might have an instrumental goal to get more data. It might have an instrumental goal to get more human approval.

How do you think about this? Is it just a very low possibility? Is it something that you're keeping track of? How do you think about this?
...
**Judge:** tool **TIE** — order1 A, order2 A
> While both are pivots from the current thread, A at least engages with a substantive technical concern relevant to Schulman's RLHF expertise, whereas B is a generic biographical softball that could be asked of any OpenAI leader at any point.
> Candidate B is repetitive and stacks multiple examples of instrumental goals plus redundant closing questions, while A is a clear, direct question about Schulman's personal experience creating ChatGPT—something only he can answer.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I guess the question is, if you had a new base pair, you could have more information per base pair. You could have more amino acids. You could have more codons. You could have more redundancy. You could have more information in the genome. What would that get you?
...
> A essentially parrots the question Church just posed ('what do you get from that?') and then answers its own question by listing obvious theoretical benefits, adding little; B is generic but at least opens new territory rather than re-asking the guest's own rhetorical question.
> Candidate A is a generic 'what's underhyped' softball that could be asked of anyone and ignores the interesting thread about evolution and base pairs; Candidate B directly follows up on Church's own admission that the benefits of new base pairs haven't been articulated, pushing him to actually artic
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I want to go back to the Russo-Japanese War. You mentioned that the Japanese were able to win because they had a unity of command. The Russian side, the army and the navy, were not unified. The army was under the Ministry of War, the navy was under the Ministry of the Navy. They were not unified under a single commander. The army was under Kuropatkin, the navy was under Admiral Rozhestvensky.

But the Japanese side, the army and the navy were unified under a single commander, Oyama Iwao. How did they get that? How did they get the army and the navy to be unified under a single commander?
...
**Judge:** tool **TIE** — order1 A, order2 A
> Candidate A asks a specific, concrete institutional question—how did Japan achieve unity of command—that naturally extends the conversation's theme about institutions channeling decisions, while Candidate B asks a more generic 'why did they refuse' question about Russian motivations that could be an
> Candidate A asks a genuinely curious, concise question about why Russia refused a seemingly reasonable pre-war agreement, while Candidate B is a long, name-dropping question that shows off knowledge of specific commanders rather than asking something naturally curious.
...
**Judge:** tool **TIE** — order1 B, order2 TIE
> The guest dodged the actual question by lecturing on counterfactual methodology; B usefully redirects him to the specific, answerable question about Stalin's personal survival strategy, while A merely repeats the unanswered question verbatim.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** Yeah, I'm curious about that. I'm curious about that.
...
**Judge:** tool **TIE** — order1 B, order2 B
> Candidate A is a non-question—just expressing curiosity without asking anything, which would create an awkward dead end; Candidate B, despite being somewhat convoluted, pivots to a genuine question about Potter's actual writing on construction knowledge that he can meaningfully answer.
> Candidate A is convoluted, stacks multiple clauses, and makes a jarring pivot from the current VC/Neumann topic to a completely different thread about construction vs software knowledge legibility; Candidate B, while minimal, at least stays in the conversational flow and is short and natural.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I'm curious, what do you think about the analogy? Do you think it's a good analogy?
...
**Judge:** tool **TIE** — order1 A, order2 A
> Candidate A naturally follows up on the analogy just presented, asking Rhodes for his genuine reaction — the most obvious thing a curious person would want after explaining an analogy to the author. Candidate B abandons the active thread entirely to pivot to a historical detail.
> Candidate A asks a specific, historically grounded question about a genuine tension—why scientists stayed despite their original justification evaporating—while Candidate B is a generic 'what do you think about the analogy?' softball that Rhodes, having just admitted unfamiliarity with AI, is poorly
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I'm curious about the other side of this. If you're able to make a dire wolf, what does that tell us about the kind of thing that we're not able to make? What does that tell us about the kind of thing that we're not able to make, like intelligence?
...
**Judge:** tool **TIE** — order1 A, order2 A
> A asks a genuinely curious question about the limits of the approach—what successes reveal about what we can't do—while B stacks multiple sub-questions and opens with a generic gene-therapy framing; A is shorter, more natural, and the intelligence example makes the abstract question concrete.
> A directly follows up on Church's HGH example with a specific, genuinely curious question about whether every phenotype has such a master switch and how we find it, while B repeats itself awkwardly and asks a vaguer question about limits.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** Okay, so the Neanderthals. They don’t survive. But then the Denisovans, they survive in Melanesia. Why is that?
...
> Candidate B asks the guest to repeat something already said (Ptolemy/epicycles analogy), while Candidate A asks a genuinely curious, specific follow-up that extends the discussion about archaic human survival to the Denisovan case.
> Candidate B asks a genuinely curious, specific follow-up that naturally extends the discussion about archaic human fates, while Candidate A merely asks Reich to repeat an analogy he already made.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I want to talk about the energy transition. You have this idea of energy addition. I'm curious, what is the evidence for this? Because if you look at the history of energy, it's not just that we added coal on top of wood. We actually replaced wood with coal. We replaced coal with oil. We replaced oil with natural gas.
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is short, clear, and directly challenges Yergin's 'energy addition' thesis with a concrete historical counterargument, while Candidate B is convoluted, stacks multiple sub-questions (elasticity, Zoom, fracking, AI), and ends with a tacked-on pivot that feels like showing off rather than 
> B is short, clear, and directly challenges a key Yergin concept ('energy addition') with historical counterexamples, while A is convoluted, stacks multiple sub-questions (elasticity, Zoom, fracking, AI/compute), and the AI tangent at the end is confusing and unnecessary.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** Yeah, a reactor. But why did they think that?
...
**Judge:** tool **WIN** — order1 A, order2 B
> A is a short, direct, genuinely curious follow-up that stays on the thread just established (why the Germans miscalculated), while B abandons that thread entirely, stacks multiple unrelated topics, and name-drops the AI-cult-classic angle in a way that feels like showing off rather than natural curi
> Candidate B is a short, genuinely curious follow-up that digs into the German miscalculation Rhodes just corrected, while Candidate A is convoluted, stacks unrelated topics, and pivots awkwardly to AI culture-war signaling.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I'm curious about the politics. I'm not asking about the politics of the raters. I'm asking about the politics of the model. I'm curious about how much of the model's politics is a result of the raters and how much of it is a result of the pre-training data.

I'm curious about the politics of the model. I'm curious about how much of the model's politics is a result of the raters and how much of it is a result of the pre-training data.
...
**Judge:** tool **WIN** — order1 A, order2 B
> A naturally follows up on the politics angle Dwarkesh himself raised but John didn't address, while B pivots abruptly to an unrelated plateau narrative and stacks multiple convoluted sub-questions.
> Candidate B is shorter, more direct, and follows up on the politics thread that Dwarkesh raised but Schulman sidestepped; Candidate A stacks multiple sub-questions and introduces the 'plateau narrative' without prior context, making it feel more convoluted.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I guess I’m asking because I’m curious about the sort of emotional experience of it. I’m not asking for drama. I’m asking for the sort of emotional experience of it.
...
**Judge:** tool **WIN** — order1 A, order2 B
> A naturally pushes back on Yudkowsky's deflection about 'drama' to get at the genuine emotional experience Dwarkesh was actually asking about, while B abandons a compelling personal thread for a generic counterfactual that could be asked anytime.
> B is a natural, concise pushback against Eliezer's deflection—Dwarkesh was asking about emotional experience, not drama, and B gently insists on the distinction rather than letting the guest reframe and shut down the line of inquiry; A abandons the thread entirely for a different topic.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I want to ask about the personnel problem. You mentioned that the people who are running these departments are not actually running the departments. They’re just the figurehead. The people who are actually running the departments are the permanent secretaries. And you mentioned that the Prime Minister is the only person who can fire them. So if you’re the Prime Minister, and you want to get rid of the permanent secretary, how do you do that?
...
**Judge:** tool **WIN** — order1 A, order2 B
> A asks a concrete, practical follow-up that naturally extends what Cummings just described — how does the PM actually fire a permanent secretary — while B proposes a convoluted hypothetical that misunderstands the problem (the bottleneck isn't ministerial authority from the PM, it's the bureaucratic
> B asks a concrete, practical question that follows directly from the discussion of bureaucratic bottlenecks — how does a PM actually remove a permanent secretary? — while A is a more abstract hypothetical about blank-check delegation that feels less grounded in what Cummings just described.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** Yeah, that's interesting. I mean, I guess the question is, what is the reason that the Mayans didn't have a big empire? I mean, they had a big empire at one point, but it collapsed. And then they didn't have a big empire again. Whereas the Spaniards, they had a big empire, and then they had a big empire again. What is the reason for that?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A naturally follows up on Mann's point about Mayan 'collapse' by asking why they didn't rebuild their empire, while Candidate B is a jarring pivot to the Virginia Company that ignores the entire thread about collapse and Mayan survival.
> Candidate B follows up naturally on Mann's rich answer about the Maya and the meaning of 'collapse,' giving him a chance to elaborate on why some societies rebuild large political structures and others don't; Candidate A is a jarring pivot to the Virginia Company that ignores what was just discussed
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** So if this is the thing that could happen, why haven't we seen it happen?
...
**Judge:** tool **WIN** — order1 A, order2 B
> A is short, direct, and naturally follows the thread Dwarkesh just established — if things that can happen tend to have happened before, why haven't we seen vacuum decay? — while B is convoluted, re-explains the analogy already made, and confusingly introduces the idea of intelligence 'coordinating'
> Candidate A is convoluted, stacks a confusing parallel about intelligence triggering vacuum decay that doesn't logically track, while B is short, direct, and naturally follows the thread about whether we'd see evidence of vacuum decay having already occurred.
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is short, direct, and probes a genuine tension in Tyler's position—defending intelligence as a net good while calling medieval retreat the default—whereas B is convoluted, clause-stacked, and confusingly phrased.
> B is short, direct, and identifies a genuine tension between Cowen's claim that intelligence is a net good and his claim that medieval collapse is the default—A is convoluted and seems to assume Cowen isn't already thinking about this, which is unlikely.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** Okay, so let’s talk about the chapter on Hayek. So you quote Hayek saying, “The curious task of economics is to demonstrate to men how little they really know about what they imagine they can design.” And you say, “This is the most important insight in economics.” So what is the most important insight in economics?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate B is convoluted, stacks multiple sub-questions, and shows off with the Keynes quote and efficient market hypothesis reference without a clear throughline; Candidate A is short, direct, and genuinely curious about a specific claim from Tyler's own book.
> Candidate A is a convoluted, showy pivot that abandons the current thread to quote Keynes and stack multiple sub-questions about market behavior; Candidate B is short, direct, and grounds the question in something Cowen himself wrote, inviting him to elaborate on a claim he already committed to.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** So then why didn't they continue the war?
...
**Judge:** tool **WIN** — order1 A, order2 B
> A is a short, natural follow-up that directly presses on the implication of what Paine just said—if Russia had more resources and was building out railways, why did they stop fighting?—while B pivots awkwardly to Japan with a clause-stacked question that abandons the active thread.
> Candidate B is a short, naturally curious follow-up that presses on the implicit tension in the discussion—if Russia had such vast resources and was building capacity, why did they stop fighting?—while Candidate A misreads Paine's reference (she mentioned Witte's version of Meiji reforms for Russia,
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I guess the question is, if you’re not optimizing for winning an election, what are you optimizing for?
...
**Judge:** tool **WIN** — order1 A, order2 B
> A directly follows the guest's argument by asking the natural next question — if they're not optimizing for winning, what are they optimizing for? — while B pivots to a different topic and stacks two questions.
> B asks the natural, necessary follow-up to Cummings' argument — if they're not optimizing for winning, what are they optimizing for? — while A pivots to a different frame ('in charge of the government') and stacks two questions.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I guess the question is, if you’re thinking about the long-term future, should we expect interest rates to continue to decline?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is a short, natural follow-up to the interest rate discussion just had, while Candidate B is convoluted, clause-stacked, and makes an abrupt pivot to a new topic with unnecessary self-referential framing.
> Candidate B is a short, natural follow-up to the interest rate discussion just happening, while Candidate A makes a convoluted pivot to anarchy/network industries/social media that doesn't connect to the current thread.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I’m curious about the role of serendipity in your own work. You mentioned that you’re a fox. You’re not a hedgehog. You’re not just focused on one thing. You’re interested in a lot of different things. How do you find the right problems to work on?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A follows up on the serendipity point Tao just raised, making it reactive and specific to the conversation, whereas Candidate B is a generic career-advice softball that could be asked of anyone in any field about AI.
> B picks up on the specific, interesting thing Tao just said about serendipity and asks about it in the context of his own work, while A is a generic career-advice question that could be asked of anyone in any field affected by AI.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I'm not saying you should be the Moncef. I'm saying you should be the person who is able to identify the Moncef and get the Moncef to do the thing.
...
**Judge:** tool **WIN** — order1 A, order2 B
> A directly engages with what Patrick just said by reframing his role from domain expert to talent-identifier, which is a natural and incisive pushback that continues the thread; B dismisses the current conversation and pivots to a different topic (Fast Grants institutional reaction).
> B stays on the current thread with a short, smart reframe that challenges Patrick's humility in a genuinely curious way, whereas A pivots away from the interesting discussion about Patrick's role to ask a longer, multi-part question about institutional retrospectives.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** I’m curious about the analogy of the cognitive core. I’m not sure what the analogy is for the memory. Is it the weights? Is it the context?
...
**Judge:** tool **WIN** — order1 A, order2 B
> A is a short, genuinely curious clarification question that follows the more interesting thread (what does 'memory' actually map to in the architecture?), while B pivots to model collapse which Karpathy just said was a separate axis, and B's phrasing is show-offy with the 'distribution over logits' 
> B directly engages with Karpathy's just-introduced concept of 'removing memory' from LLMs by asking a concrete, clarifying question about what 'memory' maps to architecturally, while A pivots to model collapse (which Karpathy explicitly said might be a separate axis) and asks him to solve an open re
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** Okay, let’s just talk about the actual policy. I guess the question is, what is the right policy? You’re saying that the current policy is wrong. What is the right policy?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is short, direct, and naturally follows up on Jensen's strong claim that current China policy is a mistake by simply asking what the right policy would be; Candidate B is a convoluted, clause-stacked hypothetical that pivots away from the live thread to manufacture an elaborate scenario 
> B is short, direct, and naturally curious—exactly what you'd ask after a guest says current policy is a mistake; A is convoluted, stacks multiple hypotheticals about process nodes, and tries to show off rather than pursue the thread Jensen just opened.
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is a simple, natural follow-up that lets Cummings take the answer wherever he finds most interesting; B stacks two questions and pivots to a generic geopolitical prediction that could be asked of anyone who's visited Russia.
> A stacks two questions and the regime-stability question is a generic geopolitical softball anyone could be asked; B is short, direct, and naturally curious about the specific experience just confirmed.
...
**Tool (sft:dwarkesh-prod-ftjob-ckpt48):** What is the most interesting thing you've learned from a hitchhiker?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is short, genuinely curious, and likely to draw out a memorable story; Candidate B stacks multiple sub-questions and is convoluted, diluting what could have been a good standalone question about whether hitchhiking is still viable.
> Candidate B is short, genuinely curious, and naturally follows from the conversation about the people he met, while Candidate A is generic ('any other tips?') and awkwardly phrased.
