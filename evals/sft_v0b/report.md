...
> Candidate A is a broken repetition of the same phrase and not a real question; Candidate B, while a slight pivot, is at least a coherent, genuine question.
> Candidate B is garbled/broken text repeating the same phrase endlessly, so A wins by default even though it's a somewhat abrupt pivot from the current thread about genius and contribution.
...
**Tool (sft:dwarkesh-run1-ckpt32):** I guess the question is, why is the Tsar less secure?

**Reference (Dwarkesh):** Didn't you say that in 1928 he had like one bodyguard when he would go to his dacha?

**Judge:** tool **LOSS** — order1 B, order2 A
> B uses a specific detail from earlier in the conversation to push back on Kotkin's claim that Stalin had more security, creating a genuine puzzle for him to resolve; A just asks a generic 'why' follow-up that adds no new angle.
> Candidate A directly challenges Kotkin's security explanation with specific evidence from the conversation, creating a genuine tension that demands a more satisfying answer, while Candidate B merely follows up on a tangent about the Tsar rather than pressing the main thread.
...
**Tool (sft:dwarkesh-run1-ckpt32):** One thing that strikes me is that the oil industry seems to be a very capital-intensive industry. Even in the early days, you need to build refineries and transport infrastructure. But it seems like the capital requirements are not so high that it prevents small entrepreneurs from getting involved. Is that true?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> B directly follows up on what Yergin just said about Rockefeller being hated and Roosevelt's trust-busting, asking a genuinely curious question about whether the hatred was inevitable or partly a PR failure; A pivots away to a generic structural question about capital intensity that doesn't build on
> Candidate A follows the natural thread of conversation about Rockefeller's unpopularity and asks a genuinely curious, specific question about whether the PR disaster was avoidable; Candidate B pivots away to a generic capital-intensity question that could be asked about any industry.
...
**Tool (sft:dwarkesh-run1-ckpt32):** But then you have the second factor, which is the peasants are not united. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many horses they have, how many oxen they have, how many cows they have, how many sheep they have, how many pigs they have. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many horses they have, how many oxen they have, how many cows they have, how many sheep they have, how many pigs they have. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many horses they have, how many oxen they have, how many cows they have, how many sheep they have, how many pigs they have. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many horses they have, how many oxen they have, how many cows they have, how many sheep they have, how many pigs they have. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many horses they have, how many oxen they have, how many cows they have, how many sheep they have, how many pigs they have. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many horses they have, how many oxen they have, how many cows they have, how many sheep they have, how many pigs they have. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many horses they have, how many oxen they have, how many cows they have, how many sheep they have, how many pigs they have. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many horses they have, how many oxen they have, how many cows they have, how many sheep they have, how many pigs they have. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many horses they have, how many oxen they have, how many cows they have, how many sheep they have, how many pigs they have. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many horses they have, how many oxen they have, how many cows they have, how many sheep they have, how many pigs they have. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many horses they have, how many oxen they have, how many cows they have, how many sheep they have, how many pigs they have. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many horses they have, how many oxen they have, how many cows they have, how many sheep they have, how many pigs they have. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many horses they have, how many oxen they have, how many cows they have, how many sheep they have, how many pigs they have. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many horses they have, how many oxen they have, how many cows they have, how many sheep they have, how many pigs they have. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many horses they have, how many oxen they have, how many cows they have, how many sheep they have, how many pigs they have. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many horses they have, how many oxen they have, how many cows they have, how many sheep they have, how many pigs they have. There's a hierarchy among the peasants. There's a hierarchy among the peasants in terms of how much land they have, how many animals they have, how many
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a broken repetitive loop disqualified as convoluted; Candidate B asks a genuine, substantive question about the psychology of mass complicity in Stalin's terror that directly advances the core topic of the interview.
> Candidate B is a glitchy repetition of the same sentence about peasant hierarchy and is incoherent, while A asks a genuine, specific question about the psychology of mass participation in Stalinist cruelty — central to the interview topic.
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is broken (repeating 'I think that's true' hundreds of times), so B wins by default even though it's a sharp pivot from the current thread.
> Candidate B is garbled repetition and not a functional question; A poses a genuinely curious, specific question about math cognition that plays to Grant's expertise.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Yeah, that makes sense. I wonder whether the way that the founder presents himself is a signal of the way that the company is going to operate. For example, if the founder is very informal, maybe the company is going to be very informal and maybe that's okay in some industries but not in others. If the founder is very formal, maybe the company is going to be very formal and maybe that's okay in some industries but not in others. Is that a reasonable way to think about it?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A merely parrots what Byrne just said about formality signaling company culture and asks for confirmation, adding no new angle; Candidate B makes a worthwhile pivot to a related but distinct topic from Byrne's actual writing, asking a specific and genuinely curious question.
> Candidate B merely paraphrases what Byrne just said (informality works in some domains, not others) and asks for confirmation, while Candidate A makes a worthwhile pivot to a concrete, novel question about scouting young talent and parental involvement distortion.
...
**Tool (sft:dwarkesh-run1-ckpt32):** But it does seem like we have a precedent of stopping countries from doing things that are dangerous even if they’re not immediately dangerous.
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A merely paraphrases the nuclear-proliferation precedent already discussed, adding nothing new; Candidate B asks a specific, direct question that forces Yudkowsky to be concrete about what regulatory regime would actually move his doom probability, advancing the conversation meaningfully.
> Candidate B merely restates the point Dwarkesh already made about nuclear proliferation precedent, adding nothing new; Candidate A asks a concrete, specific follow-up about what regulatory level would actually satisfy Yudkowsky, pushing the conversation forward.
...
**Tool (sft:dwarkesh-run1-ckpt32):** But I’m wondering, what is the evidence that you’re right? What is the evidence that you’re right about the downstream demand? Because I feel like the downstream demand is the thing that’s uncertain. There’s a lot of uncertainty about whether the downstream demand is going to be there.
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate B pivots to the core topic of the interview with a specific, factual challenge (two top models trained on TPU), while Candidate A vaguely asks for 'evidence you're right' and slightly mischaracterizes Jensen's point about energy constraints as being about demand uncertainty.
> A directly engages the stated topic with a concrete, specific observation (two top models trained on TPUs) and asks a genuinely curious competitive question, while B mischaracterizes Jensen's point—he was saying energy is a bottleneck, not making a claim about uncertain downstream demand.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Yeah, I agree. I've noticed that too. I think it's because the podcast format allows you to talk about topics that are more niche and more complicated. So you can have a longer conversation about it. Whereas in the mainstream media, you have to fit everything into a five-minute segment. So you can't really dive into the details. So I think that's why the podcast format is better suited for these kinds of conversations. Anyway, getting back to the Wizard and Prophet question, I wanted to ask you about the food issue. So you mentioned that the wizards would say that science and technology can help us produce our way out of these environmental dilemmas. And the prophets would say that there are natural limits to how much we can produce. So what do you think about the current state of agriculture? Are we approaching the limits of what we can produce? Or are we still able to increase production through science and technology?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A wastes time agreeing with the guest about podcasts before asking a generic softball about agricultural limits, while Candidate B poses a specific, genuinely interesting counterfactual about Norman Borlaug that directly engages with Mann's work and invites a substantive response.
> Candidate A asks a specific, genuinely interesting counterfactual question about Borlaug and technological contingency that directly engages the Wizard/Prophet framework, while Candidate B asks a generic softball ('are we approaching limits or can tech save us?') that just asks Mann to restate his b
...
**Tool (sft:dwarkesh-run1-ckpt32):** What is your estimate of the timeline until we have these benefits? You mentioned that the timeline for the dangers is shorter than the timeline for the benefits. What is your estimate of the timeline for the benefits?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate B is short, direct, and ties the interview's core topic to what Dario just said about export controls, while Candidate A fabricates a claim about Dario saying dangers have a shorter timeline than benefits and asks a generic timeline question.
> Candidate A directly ties the interview's core topic to what Amodei just said about export controls, asking a short, genuinely curious question that probes the reasoning behind his position; Candidate B misattributes a claim to the guest and asks a generic timeline question.
...
**Tool (sft:dwarkesh-run1-ckpt32):** I'm curious about the relationship between the oil industry and the military. Obviously, the military needs oil. But in the context of the Cold War, what was the relationship between the oil industry and the military?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate B is specific, follows directly from the 1973 discussion just mentioned, and asks a genuinely curious counterintuitive question; Candidate A is a vague, generic softball ('what was the relationship?') that could be asked anywhere and adds nothing to the current thread.
> Candidate A follows naturally from the just-discussed 1973 crisis and 'oil weapon,' asking a specific, genuinely curious question about why the shock was so large despite modest supply drops; Candidate B pivots to a generic broad question about oil and the military that doesn't connect to the recent
...
**Tool (sft:dwarkesh-run1-ckpt32):** What is the difference between the way you think about this and the way that people who are like — “Yeah, this is a big deal. We should be worried about it,” but who are not as extreme as you are? What is the difference in the way you think about it?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a generic comparison question that could be asked at any point and doesn't build on the emotional thread just opened; Candidate B is a specific, genuinely curious question about the counterfactual history of the alignment field that many listeners would want the answer to.
> Candidate A is a specific, clear question that a genuinely curious person would want answered; Candidate B is vague ('difference in the way you think about it') and generic enough to be asked at any point, adding little to the current thread.
...
**Tool (sft:dwarkesh-run1-ckpt32):** I want to talk about the arc of your career. You've gone from building a tool for eBay sellers to building a tool for developers to accepting payments to building tools for scientists to doing science yourself. How has your conception of what you're trying to do evolved over the course of your career?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a generic career-reflection softball that could be asked of any accomplished person; Candidate B asks a specific, forward-looking question genuinely rooted in Patrick's expertise about what adjacent businesses to payments might emerge—directly extending the thread about how payment in
> Candidate A follows the conversation thread about how Stripe infrastructure enables unexpected monetization, while Candidate B pivots to a generic career-arc question that ignores what was just discussed.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Interesting. Yeah, I agree with you. I think the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the reason why people are interested in collapse is because they're worried about our civilization collapsing. But I wonder if the
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a garbled repetition loop and is disqualified; Candidate B asks a specific, concrete historical question that invites a focused, interesting answer.
> Candidate B is a broken repetitive loop and disqualified; Candidate A is a specific, genuinely curious question about colonial persistence that Mann is well-positioned to answer.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Yeah, I'm curious, what makes some of these scientists better forecasters than others? Because I think there's a general lesson here. What makes somebody able to predict the future of a technology?

**Reference (Dwarkesh):** When you were interviewing the scientists, how many of them did you feel regretted their work?

**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A simply re-asks the forecasting question Dwarkesh already posed and Rhodes already answered, while Candidate B pivots to a genuinely new and compelling angle — scientist regret — that naturally follows from discussing transformative, world-changing work.
> Candidate B simply re-asks the forecasting question Dwarkesh already posed and Rhodes already answered, while Candidate A offers a genuine, naturally curious new angle that would open a rich line of discussion.
...
**Tool (sft:dwarkesh-run1-ckpt32):** What are the implications of this for the future of China? Is this a problem that will continue to persist?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a generic softball ('what are the implications for the future?') that could be asked about any institutional problem; Candidate B asks a specific, genuinely puzzling historical question about why Russia refused a pre-war deal that would have left them better off, which is the kind of 
> Candidate B is a generic softball ('implications for the future of China?') that could be asked about any institutional problem, while Candidate A asks a specific, genuinely puzzling question about a concrete historical decision—why Russia refused a seemingly favorable pre-war agreement—that a curio
...
**Tool (sft:dwarkesh-run1-ckpt32):** Okay, so let's talk about the other side of this. Let's suppose that we want to make buildings more beautiful. We want to make them more aesthetically pleasing. What are the constraints on doing that? What are the trade-offs? What are the things that we'd have to give up?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a generic 'what are the trade-offs' question that could be asked about anything and invites a list-y answer; Candidate B is short, specific, and genuinely curious about a technical detail Brian raised, the kind of natural follow-up a curious interviewer would actually wonder about.
> A is a short, specific, genuinely curious follow-up on a concrete technical claim Brian just made, whereas B is a generic 'what are the trade-offs' question that could be asked of anyone about anything.
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Kotkin dodged the original question with a meta-tangent about counterfactuals; B narrows the question to the specific, answerable angle—how Stalin would have personally survived being purged—making it harder to dodge again, while A just vaguely re-asks the same broad question.
> Kotkin sidestepped the actual question to give a meta-point about counterfactuals; A usefully clarifies the personal-survival angle (how would Stalin avoid being purged himself?) that was the heart of the original question, while B is too vague to redirect him.
...
**Tool (sft:dwarkesh-run1-ckpt32):** But let's suppose that they had some success in the early stages of the war. They had some success in the Philippines. They had some success in Malaya. They had some success in Indonesia. They had some success in Burma. They had some success in the Dutch East Indies. They had some success in Singapore. They had some success in Thailand. They had some success in the Solomon Islands. They had some success in Guadalcanal. They had some success in the Aleutians. They had some success in the Gilbert Islands. They had some success in the Marshall Islands. They had some success in the Caroline Islands. They had some success in the Mariana Islands. They had some success in the Bonin Islands. They had some success in the Ryukyu Islands. They had some success in the Kuril Islands. They had some success in the Sakhalin Islands. They had some success in the Kamchatka Peninsula. They had some success in the Amur River region. They had some success in the Ussuri River region. They had some success in the Manchurian region. They had some success in the Mongolian region. They had some success in the Tibetan region. They had some success in the Xinjiang region. They had some success in the Inner Mongolian region. They had some success in the Shanxi region. They had some success in the Shaanxi region. They had some success in the Henan region. They had some success in the Hubei region. They had some success in the Hunan region. They had some success in the Jiangxi region. They had some success in the Fujian region. They had some success in the Guangdong region. They had some success in the Guangxi region. They had some success in the Yunnan region. They had some success in the Guizhou region. They had some success in the Sichuan region. They had some success in the Chongqing region. They had some success in the Nanjing region. They had some success in the Shanghai region. They had some success in the Hangzhou region. They had some success in the Ningbo region. They had some success in the Wenzhou region. They had some success in the Quanzhou region. They had some success in the Xiamen region. They had some success in the Fuzhou region. They had some success in the Taizhou region. They had some success in the Lishui region. They had some success in the Jinhua region. They had some success in the Zhoushan region. They had some success in the Putuo region. They had some success in the Dinghai region. They had some success in the Daishan region. They had some success in the Changxing Island region. They had some success in the Chongming Island region. They had some success in the Jiuduansha region. They had some success in the Yangshan Deep-Water Port region. They had some success in the Lingang Special Area region. They had some success in the Pudong New Area region. They had some success in the Lujiazui Financial District region. They had some success in the Zhangjiang Hi-Tech Park region. They had some success in the Waigaoqiao Free Trade Zone region. They had some success in the Jinshan Industrial Park region. They had some success in the Songjiang Industrial Park region. They had some success in the Fengxian Industrial Park region. They had some success in the Qingpu Industrial Park region. They had some success in the Baoshan Industrial Park region. They had some success in the Minhang Industrial Park region. They had some success in the Jiading Industrial Park region. They had some success in the Chongming Industrial Park region. They had some success in the Nanhui Industrial Park region. They had some success in the Pudong Airport Industrial Park region. They had some success in the Pudong International Airport region. They had some success in the Pudong New Area region. They had some success in the Pudong International Airport region. They had some success in the Pudong New Area region. They had some success in the Pudong International Airport region. They had some success in the Pudong New Area region. They had some success in the Pudong International Airport region. They had some success in the Pudong New Area region. They had some success in the Pudong International Airport region. They had some success in the Pudong New Area region. They had some success in the Pudong International Airport region. They had some success in the Pudong New Area region. They had some success in the Pudong International Airport region. They had some success in the Pudong New Area region. They had some success in the Pudong International Airport region. They had some success in the Pudong New Area region. They had some success in the Pudong International Airport region.
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a broken, repetitive output listing regions endlessly and not a real question; Candidate B at least poses a genuine comparative question about why Meiji reforms succeeded in Japan but similar top-down reform failed in Russia.
> Candidate B is a broken, repetitive list of place names with no coherent question, while Candidate A asks a genuine comparative question about why Meiji-era top-down reform succeeded in Japan but failed in Russia, which connects meaningfully to the conversation's theme of Japanese vs. Russian outcom
...
**Tool (sft:dwarkesh-run1-ckpt32):** Yeah. But I guess the point I’m trying to make is that if you’re thinking about the long term, and you’re thinking about the long term in terms of intelligence, then you should be calling forth the AI.
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is barely a question—it's a confusing statement that doesn't clearly follow from what Tyler said. Candidate B, though convoluted, contains a genuine and interesting question: if Tyler thinks retreat to a preindustrial state is the default, why isn't avoiding that more central to his thin
> Candidate A asks a genuine follow-up question probing a real tension in Tyler's position (if medieval collapse is the default, shouldn't avoiding it centrally frame how we evaluate new tech?), whereas Candidate B is more of a statement/argument than a question and doesn't clearly follow from Tyler's
...
**Tool (sft:dwarkesh-run1-ckpt32):** Yeah, I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve heard that. I’ve
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is nonsensical gibberish repeating the same phrase hundreds of times, while Candidate B at least poses a genuine question about Cowen's work on anarchy and network industries applied to social media.
> Candidate B is a malformed output repeating the same phrase hundreds of times and is not a real question, while Candidate A poses a substantive question connecting Cowen's work on network industries to social media dynamics.
...
**Tool (sft:dwarkesh-run1-ckpt32):** How do you think the process of science will change in the future? Will it be more like the current process, but scaled up, or will it be fundamentally different?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a generic softball ('how will science change?') that could be asked of anyone; Candidate B, despite its length, builds directly on Tao's Darwin/Newton comparison with a specific, answerable question about whether progress concentrates in domains with tight verification loops.
> Candidate B is a generic softball ('how will science change in the future?') that could be asked of anyone; Candidate A, despite its overly elaborate and show-offy delivery, contains a genuinely specific and interesting question about whether progress concentrates in domains with tight verification 
...
**Tool (sft:dwarkesh-run1-ckpt32):** I'm curious about the relationship between the two of you. Obviously, you're brothers, but you're also co-founders. How do you divide responsibilities? How do you resolve disagreements?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate B offers a creative, specific angle on the partnership thread just established by the Munger/Buffett comparison, while Candidate A is a generic co-founder question that could be asked of any sibling pair.
> Candidate A draws a novel, genuinely curious parallel (co-founder partnership ≈ marriage) that could yield a unique and personal answer, while Candidate B is a generic co-founder question ('divide responsibilities? resolve disagreements?') that could be asked of any founding pair.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Let's talk about the actual development of the bomb. What were the key bottlenecks? Was it getting the fissile material? Was it figuring out the engineering of the bomb? Was it figuring out the physics?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate B asks a specific, genuinely curious question about a real historical tension (why scientists stayed after the Nazi threat evaporated), while Candidate A is a generic softball about bottlenecks that could be asked of anyone familiar with the Manhattan Project and ignores the interesting th
> Candidate A asks a specific, genuinely curious question about a real historical tension (scientists not quitting after their stated rationale disappeared), while Candidate B is a generic 'what were the bottlenecks' question that could be asked about any project.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Okay, let’s talk about the other side of the equation. Let’s assume that the benefits of having these chips in China are minimal. There’s no benefit to the US economy. There’s no benefit to the US tech stack. There’s no benefit to the US military. There’s no benefit to the US intelligence community. There’s no benefit to the US government. There’s no benefit to the US private sector. There’s no benefit to the US universities. There’s no benefit to the US startups. There’s no benefit to the US consumers. There’s no benefit to the US citizens. There’s no benefit to the US taxpayers. There’s no benefit to the US voters. There’s no benefit to the US politicians. There’s no benefit to the US media. There’s no benefit to the US culture. There’s no benefit to the US education system. There’s no benefit to the US healthcare system. There’s no benefit to the US transportation system. There’s no benefit to the US energy system. There’s no benefit to the US environment. There’s no benefit to the US security. There’s no benefit to the US democracy. There’s no benefit to the US freedom. There’s no benefit to the US prosperity. There’s no benefit to the US happiness. There’s no benefit to the US peace. There’s no benefit to the US justice. There’s no benefit to the US equality. There’s no benefit to the US diversity. There’s no benefit to the US inclusion. There’s no benefit to the US innovation. There’s no benefit to the US creativity. There’s no benefit to the US imagination. There’s no benefit to the US curiosity. There’s no benefit to the US exploration. There’s no benefit to the US discovery. There’s no benefit to the US invention. There’s no benefit to the US progress. There’s no benefit to the US development. There’s no benefit to the US growth. There’s no benefit to the US expansion. There’s no benefit to the US advancement. There’s no benefit to the US improvement. There’s no benefit to the US enhancement. There’s no benefit to the US enrichment. There’s no benefit to the US elevation. There’s no benefit to the US upliftment. There’s no benefit to the US empowerment. There’s no benefit to the US liberation. There’s no benefit to the US emancipation. There’s no benefit to the US independence. There’s no benefit to the US sovereignty. There’s no benefit to the US autonomy. There’s no benefit to the US self-determination. There’s no benefit to the US self-reliance. There’s no benefit to the US self-sufficiency. There’s no benefit to the US self-support. There’s no benefit to the US self-maintenance. There’s no benefit to the US self-preservation. There’s no benefit to the US self-defense. There’s no benefit to the US self-protection. There’s no benefit to the US self-security. There’s no benefit to the US self-safety. There’s no benefit to the US self-well-being. There’s no benefit to the US self-health. There’s no benefit to the US self-healing. There’s no benefit to the US self-care. There’s no benefit to the US self-love. There’s no benefit to the US self-respect. There’s no benefit to the US self-esteem. There’s no benefit to the US self-confidence. There’s no benefit to the US self-assurance. There’s no benefit to the US self-belief. There’s no benefit to the US self-trust. There’s no benefit to the US self-faith. There’s no benefit to the US self-hope. There’s no benefit to the US self-expectation. There’s no benefit to the US self-aspiration. There’s no benefit to the US self-ambition. There’s no benefit to the US self-goal. There’s no benefit to the US self-objective. There’s no benefit to the US self-purpose. There’s no benefit to the US self-meaning. There’s no benefit to the US self-value. There’s no benefit to the US self-importance. There’s no benefit to the US self-significance. There’s no benefit to the US self-weight. There’s no benefit to the US self-gravity. There’s no benefit to the US self-density. There’s no benefit to the US self-mass. There’s no benefit to the US self-energy. There’s no benefit to the US self-power. There’s no benefit to the US self-force. There’s no benefit to the US self-pressure. There’s no benefit to the US self-stress. There’s no benefit to the US self-strain. There’s no benefit to the US self-tension. There’s no benefit to the US self-shear. There’s no benefit to the US self-bend. There’s no benefit to the US self-twist. There’s no
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a broken, repetitive list that devolves into nonsense; Candidate B asks a specific, concrete follow-up that builds on the discussion of process nodes and architecture vs. manufacturing.
> Candidate B is a broken, endlessly repetitive list that is completely incoherent; Candidate A asks a specific, genuinely curious strategic question that builds on the earlier TSMC discussion and Jensen's own point that architecture matters more than process node.
...
**Tool (sft:dwarkesh-run1-ckpt32):** What are the other things you've learned from this experience?
...
**Judge:** tool **LOSS** — order1 B, order2 A
> Candidate A is a generic softball ('what did you learn?') that could be asked about any experience; Candidate B asks a specific, genuinely curious question about whether hitchhiking is still viable today given how uncommon it's become.
> Candidate B is a generic softball ('what did you learn?') that could follow any experience discussion, while A at least raises a specific, genuinely curious angle about whether hitchhiking is still viable in the modern world.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Is it possible that the reason that Neanderthals and modern humans have these similarities is because they’re both adapted to cold climates?
...
> Candidate B directly engages with the puzzle Reich just raised by asking what mechanism could explain the Neanderthal-modern human connection, while Candidate A's cold-climate hypothesis doesn't fit well since modern humans evolved in Africa.
> A largely paraphrases the interbreeding mechanism Reich already explained, while B introduces a genuinely new explanatory hypothesis (convergent evolution via shared climate pressures) that Reich hasn't addressed, giving him something fresh to react to.
...
> Candidate A is short, direct, and naturally curious—exactly what a real interviewer would ask next. Candidate B pads the same question with essay name-dropping and technical jargon that signals the asker's reading rather than genuine curiosity.
> A references the guest's own essay and points to a specific technical challenge (superlinear lateral forces), making it more likely to yield a concrete, interesting answer than B's generic open-ended question.
...
**Tool (sft:dwarkesh-run1-ckpt32):** So let's talk about the black hole interior. How does the holographic principle apply to that?
...
**Judge:** tool **TIE** — order1 A, order2 A
> Candidate A is short, clear, and specific about an important application of holography; Candidate B is long, meandering, stacks multiple sub-questions, and buries its one genuinely interesting point (de Sitter) at the end after a confusing Hilbert space analogy.
> Candidate A genuinely engages with the guest's philosophical point about equivalence and raises the crucial de Sitter question — since our universe isn't AdS, asking what the boundary would mean in a de Sitter world is a natural, important follow-up that advances the conversation; Candidate B is a g
...
**Tool (sft:dwarkesh-run1-ckpt32):** What is the difference between the model knowing what it knows and the model knowing what it doesn't know?
...
**Judge:** tool **TIE** — order1 B, order2 B
> Candidate A manufactures a distinction that isn't clearly there—'knowing what you know' vs 'knowing what you don't know' are two sides of the same calibration coin, and John already addressed this—while Candidate B makes a deliberate, worthwhile pivot to John's unique personal history creating ChatG
> Candidate B is a short, direct follow-up that probes the distinction John just raised about models 'knowing what they know' and their calibration, while Candidate A abandons an interesting technical thread for a generic biographical pivot.
...
**Tool (sft:dwarkesh-run1-ckpt32):** What is the biggest bottleneck in the progress of synthetic biology? Is it our understanding of biology? Is it our ability to synthesize DNA? Is it our ability to edit DNA?
...
**Judge:** tool **TIE** — order1 B, order2 B
> Candidate A is a generic bottleneck question that could be asked of any synthetic biologist; Candidate B, while also a common format, is more likely to yield a surprising and specific answer given Church's unusually broad research portfolio.
> Candidate A is a generic softball that could be asked of any researcher; Candidate B follows naturally from the discussion of synthetic biology's capabilities and asks a specific, genuinely curious question about what's actually holding the field back.
...
**Tool (sft:dwarkesh-run1-ckpt32):** But surely there will be a year when you realize that most mathematical progress is being made by AI. When is that year?
...
**Judge:** tool **TIE** — order1 B, order2 B
> Candidate A merely re-asks the same question Dwarkesh already posed and Tao already addressed (hybrids will dominate longer, timeline is unpredictable); Candidate B pivots to a natural, practical follow-up that a genuinely curious person would want Tao's answer to.
> Candidate A is a generic career-advice softball that could be asked of anyone in any field; Candidate B presses Tao on his evasion of the concrete prediction, which is exactly the right move when a guest hedges on a specific question they were already asked.
...
**Tool (sft:dwarkesh-run1-ckpt32):** So let’s talk about the 50,000 to 100,000-year event. What is your current understanding of what happened?
...
**Judge:** tool **TIE** — order1 B, order2 B
> Candidate B asks a specific, genuinely curious follow-up about genetic differences across time depths that directly extends Reich's point about where genetic divergence actually shows up, while Candidate A asks a generic softball ('what is your understanding of what happened?') that could be asked o
> Candidate A mischaracterizes what Reich just said (he didn't claim 'no fixed differences'), while B is a simple, natural follow-up that picks up on the contrast Reich himself introduced and asks him to elaborate.
...
**Tool (sft:dwarkesh-run1-ckpt32):** I guess the question is, what is the Moncef of the problem? Who is the Moncef of the problem?
...
**Judge:** tool **TIE** — order1 B, order2 B
> Candidate A is vague and likely to just get a repeat of 'it depends on the problem,' while B asks a specific, concrete question about institutional reaction to Fast Grants that could yield a substantive and interesting answer.
> B is short, direct, and naturally follows up on what Patrick just said about finding the right domain expert, whereas A pivots away from the current thread, stacks multiple sub-questions, and opens with flattery rather than genuine curiosity.
...
**Tool (sft:dwarkesh-run1-ckpt32):** That's interesting. I'm wondering if you can apply this to the question of — Are we under bubbled? Because the way you describe it, it sounds like the way to get out of this situation is to have a leader who has a vision and is willing to spend a lot of money and is willing to take a lot of risks and is willing to ignore the naysayers and just go forward with this vision. But the way you described it, it sounded like that's exactly what we have with Elon Musk and Twitter. He's taking a lot of risks. He's spending a lot of money. He's ignoring the naysayers. He's going forward with this vision. But it doesn't seem like it's producing a lot of value. It seems like it's just producing a lot of chaos.
...
**Judge:** tool **TIE** — order1 B, order2 B
> Candidate A is convoluted and never arrives at a clear question—it stacks clauses and makes a muddled argument about bubbles that doesn't logically follow from what was said; Candidate B, despite a long setup with an unnecessary Civ analogy, reaches a genuinely interesting and specific question abou
> B is shorter, directly engages with what Byrne just said about personal vs institutional legitimacy, and asks a genuinely curious follow-up about whether the Musk model is actually working — whereas A is long, show-offy (Civ analogy, Fukuyama name-drop), and asks an abstract question that buries the
...
**Tool (sft:dwarkesh-run1-ckpt32):** Is there a way in which we can build up defenses against synthetic biology that are not just defensive, but offensive? Like, if somebody creates a virus, we can immediately create another virus that kills that virus?
...
**Judge:** tool **TIE** — order1 A, order2 A
> A asks a concrete, genuinely curious technical question about offensive bio-defense that follows naturally from the arms-race discussion, while B is more of a comment with a weak tag question about the well-worn dual-use observation.
> A smartly pushes back on Church's nuclear comparison by highlighting a crucial difference—biology is inherently dual-use and we actually want it to advance—while personally connecting to Church's own work on cheap sequencing, creating a genuine tension for him to respond to.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Yeah, I guess the question is, is there a way to make the sweet more sweet and the bitter less bitter? Or is it just inevitable that both come together?
...
> Candidate A is a short, natural follow-up that directly engages with Mann's 'bitter with the sweet' framing and pushes it somewhere useful, while Candidate B is a long, clause-stacked pivot that abandons the current thread and asks Mann to explain a huge civilizational question on the spot.
> B is a short, natural follow-up that directly engages the 'bitter with the sweet' framing Mann just introduced, while A pivots away to an earlier topic with a long, clause-stacked question.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Let’s talk about the geopolitical implications of this. How do you think about the fact that the US is ahead in AI? Is that something that you think is good? Is that something that you think is bad?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A naturally follows the geographic inequality thread Dario just opened, while Candidate B abandons it for a speculative pivot to robotics with stacked reasoning.
> B follows the thread Dario just opened about geographic concentration of AI benefits, extending it to the geopolitical dimension, while A ignores Dario's stated worry and pivots to an unrelated robotics question.
...
**Tool (sft:dwarkesh-run1-ckpt32):** But the thing about the witness is that it's not explicitly trying to teach you math. It's just that the way that it's designed is that it feels like you're doing math. Is that true?
...
**Judge:** tool **WIN** — order1 A, order2 B
> A is short, specific, and genuinely curious—picking up on the game thread with a concrete example (The Witness) and asking a sharp question about the feeling of doing math versus explicit teaching, while B is a generic 'should educators go online' question that could be asked of anyone and doesn't r
> B is a short, specific, genuinely curious question that drills into the actual mechanism of how a game like The Witness relates to math learning, while A is a generic scale-of-educators question that could be asked of anyone in online education and doesn't react to what Grant just said.
...
**Tool (sft:dwarkesh-run1-ckpt32):** So the Neanderthals, they have the Middle Stone Age tools. They have the same toolkit as us. They have the same mitochondrial DNA. They have the same Y chromosome. What else do they have?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A follows up directly on the current thread by asking what other surprising similarities Neanderthals share with us, while Candidate B asks Reich to recapitulate something he already said, which would move the conversation backward.
> Candidate B is a short, genuinely curious follow-up that extends the conversation by asking what other similarities exist, while Candidate A asks Reich to recapitulate something already said, adding no new angle.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Let's talk about the future of oil. You've written about the undulating plateau. What is the evidence for that? What is the evidence that we're not going to run out of oil?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is short, direct, and references Yergin's actual concept (the undulating plateau), making it a genuinely curious question; Candidate B is a convoluted, clause-stacking question that tries to sound sophisticated by citing the Arab oil embargo, Zoom, fracking, and AI all at once, ending wi
> Candidate A is convoluted, stacking multiple sub-questions (elasticity, Zoom, fracking, AI compute) into one meandering prompt, while B is short, direct, and genuinely curious about a specific concept Yergin has written about.
...
**Tool (sft:dwarkesh-run1-ckpt32):** I wonder if we’ll eventually have a tool that just transcribes the conversation between you and the author of the paper and then summarizes it.
...
**Judge:** tool **WIN** — order1 A, order2 B
> A is short, naturally curious, and cleverly bridges the education and AI threads by asking whether AI could capture the conversational explanation they just agreed is superior; B is a generic 'how do you learn?' question that could be asked of any expert.
> Candidate B is a short, genuinely curious follow-up that naturally bridges the current discussion (beer conversation > paper) with the AI thread of the interview, while Candidate A asks a generic learning-strategies question that likely retreads already-covered pedagogy ground.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Yeah, okay. Why did they think that?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is a short, naturally curious follow-up that drills into what Rhodes just corrected, while Candidate B stacks multiple topics and pivots awkwardly to an AI connection that feels like showing off rather than genuine curiosity.
> B is a short, naturally curious follow-up that drills into what the guest just said (the German miscalculation), while A is a convoluted, clause-stacking question that pivots awkwardly to an irrelevant AI-culture angle.
...
**Tool (sft:dwarkesh-run1-ckpt32):** What are the areas that you would be tempted to go work on?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is short, direct, and naturally curious—Byrne just gave two specific examples of tempting domains, so asking what other areas pull on him is the obvious follow-up; Candidate B is a long, leading, statement-heavy question that pivots away from the current thread to force a parallel that t
> B is short, direct, and naturally curious about the concrete thing Byrne just shared (his personal 'temptation' industries), while A is a long, clause-stacking paraphrase that asks for confirmation of a framework rather than opening new ground.
...
**Tool (sft:dwarkesh-run1-ckpt32):** This is a good segue into the Equational Theories project that you started recently. Can you describe what that is?
...
**Judge:** tool **WIN** — order1 A, order2 B
> A is short, specific, and naturally follows Tao's point about experimental math at scale by referencing a concrete project he's working on; B is a convoluted, clause-stacked question asking Tao to quantify an unanswerable hypothetical about technique overhang.
> B is short, direct, and naturally curious — it asks Tao to ground his abstract point about experimental math at scale in a concrete project he's actually leading, whereas A is a convoluted, clause-stacked question that asks Tao to speculate about an overhang he'd have no precise way to quantify on t
...
**Tool (sft:dwarkesh-run1-ckpt32):** What is the difference between the way you do co-design and the way Google does co-design?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is short, direct, and genuinely curious—picking up on Jensen's fresh claim about 'extreme co-design' and asking him to differentiate from Google's approach—while Candidate B is a lengthy, show-offy counter-argument buried under stacked clauses and name-drops that could be cut to a single
> Candidate B is short, direct, and genuinely curious—following up on Jensen's own emphasis on co-design as Nvidia's advantage by asking him to contrast it with Google's approach, while Candidate A is a long, clause-stacked lecture that buries its one interesting point under a mountain of assertions.
...
**Tool (sft:dwarkesh-run1-ckpt32):** What is the distribution of political views among the raters?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is a short, direct follow-up to Dwarkesh's earlier question about rater politics that Schulman dodged, while Candidate B is a convoluted, clause-stacked pivot to an unrelated 'plateau narrative' that tries to sound deep.
> Candidate B is short, direct, and follows up on a specific question Dwarkesh already asked ('What are their politics?') that John deflected—this is good interviewing persistence. Candidate A has an interesting core question but is convoluted, stacks multiple sub-questions, and buries its point in ve
...
**Tool (sft:dwarkesh-run1-ckpt32):** How much of this is due to the fact that the Prime Minister is the only person who can do this? How much of this is due to the fact that the Prime Minister doesn’t want to do this?
...
**Judge:** tool **WIN** — order1 A, order2 B
> A is short, direct, and probes a genuinely important distinction—structural constraint vs. political will—that naturally follows from Cummings's account, whereas B is a convoluted hypothetical that stacks clauses and asks about an artificial mechanism rather than something Cummings would have real i
> B is a short, sharp question that cuts to the real diagnostic tension—whether the bottleneck is structural or voluntary—while A is a convoluted hypothetical about an unrealistic 'blank check' mechanism.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Interesting. You mentioned earlier that you expect that the models will be doing SWE end-to-end. What is the timeline for that? Is it a year or two?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is short, direct, and naturally follows the conversation about coding models; Candidate B is a convoluted, clause-stacking pivot that asks Dario to describe an entire alignment equilibrium vision on the spot.
> Candidate A is the classic over-elaborate, clause-stacking question that manufactures dramatic tension and pivots away from what Dario just said; Candidate B is short, specific, and naturally follows the coding discussion thread.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Yeah, okay. So if this is the thing that could happen, you might expect that there are examples of it happening somewhere in the universe. Is there evidence of that?
...
**Judge:** tool **WIN** — order1 A, order2 B
> B is convoluted and clause-stacked, trying to introduce an intelligence-triggered angle but phrasing it so confusingly it's hard to parse; A is short, clear, and naturally follows the analogy into a concrete question about evidence of vacuum decay occurring in the universe.
> Both ask essentially the same follow-up — has vacuum decay happened somewhere in the universe? — but B is short, direct, and genuinely curious, while A is convoluted, clause-stacked, and buries the real question under unnecessary scaffolding about intelligent species coordinating.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Yeah, I guess that's a possibility. Now, I want to talk about nuclear power plants. In your post, you mention that the cost of nuclear power plants has increased dramatically over time. Why is that?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is short, clear, and specific—asking about a concrete claim from Brian's work—while Candidate B is a convoluted, meandering question that stacks clauses and ends with garbled phrasing.
> Candidate A is convoluted, clause-stacked, and manufactures a vague parallel between construction and software; Candidate B is short, direct, and asks a specific question about a concrete topic Potter has written on.
...
**Tool (sft:dwarkesh-run1-ckpt32):** So, okay, let’s talk about the general theory. You say that the general theory is the most important book in economics ever written. Why is that?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate B is convoluted, stacks multiple sub-questions, quotes Keynes at length to show off, and asks a confusingly phrased question about market behavior; Candidate A is short, direct, and clearly answerable.
> Candidate A is a convoluted, show-offy question that stacks a Keynes quote, an interpretation, a Covid observation, and a vague final question — classic LLM-style faux-depth. Candidate B is short, direct, and genuinely curious, inviting Cowen to explain a concrete claim he's made.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Okay, so once the Trans-Siberian Railway is finished, why couldn't they continue the war?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is a short, natural follow-up that stays on the thread about railways and Russia's war-fighting capacity, while Candidate B awkwardly pivots to Japan, uses corporate jargon ('double click'), and stacks clauses before reaching its question.
> B follows up directly on the correction Paine just made about the railway's completion timeline, asking a natural and genuinely curious question about whether the railway was really the binding constraint; A pivots away to Japan's side and asks a somewhat generic question about how literacy helps mo
...
**Tool (sft:dwarkesh-run1-ckpt32):** So what is the mechanism by which they’re not optimizing for winning an election? Is it that they’re optimizing for something else? Or is it that they’re just incompetent?
...
**Judge:** tool **WIN** — order1 A, order2 B
> A directly follows up on the guest's argument by asking the natural next question — if they're not optimizing for winning, what are they optimizing for? — while B pivots to an entirely different topic about who's 'in charge' and stacks two questions.
> B directly follows up on Cummings's claim that politicians aren't optimizing for winning elections by asking the natural next question—what are they optimizing for instead—while A pivots to a different topic entirely.
...
**Tool (sft:dwarkesh-run1-ckpt32):** So what is the difference between uploading and AI?
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is a short, genuinely curious follow-up to Yudkowsky's claim that uploads 'do not have the utter lethality of artificial intelligence'—asking what the difference is flows naturally from what he just said, while Candidate B is a convoluted, performative pivot to a new topic that stacks cl
> B is a short, genuinely curious follow-up to Yudkowsky's specific claim that uploads 'do not have the utter lethality of artificial intelligence,' while A is a convoluted, show-offy analogy that manufactures a tension and stacks clauses rather than reacting naturally to what was just said.
...
**Tool (sft:dwarkesh-run1-ckpt32):** But what is the thing that we're waiting for? What is the thing that we're solving?
...
**Judge:** tool **WIN** — order1 A, order2 B
> A is short, direct, and genuinely curious—asking John to specify what the actual alignment milestone is—while B is a long, clause-stacked restatement of the scenario before arriving at a related but more abstract question about 'proof' that could have been asked simply.
> B cuts straight to the heart of the matter with genuine curiosity and brevity, while A paraphrases what was just said and stacks unnecessary context before arriving at essentially the same question.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Is there a way to make them worse at memorization?
...
**Judge:** tool **WIN** — order1 A, order2 B
> A is short, direct, and naturally follows Karpathy's claim that we should remove memorization — the obvious curious question is 'how?' — while B pivots back to model collapse which Karpathy just said was likely a separate axis, and B's elaborate framing shows off the interviewer's own ideas rather t
> B is short, direct, and follows the thread Karpathy was actually developing (wanting to remove memorization), whereas A pushes on model collapse which Karpathy just distanced himself from, asks multiple convoluted sub-questions, and asks him to solve an open problem on the spot.
...
**Tool (sft:dwarkesh-run1-ckpt32):** Is there a reason to believe that intelligence is similar to height in this regard?
...
**Judge:** tool **WIN** — order1 A, order2 B
> A is short, direct, and naturally follows up on the intelligence thread the interviewer raised but George answered only with height; B is convoluted, stacks multiple sub-questions, and opens with a generic softball about 'gene therapy in general.'
> B is short, direct, and naturally follows the thread—connecting the intelligence example the interviewer raised earlier with Church's height/HGH analogy—while A stacks multiple sub-questions and opens with a generic gene-therapy framing.
...
**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is short, open, and genuinely curious—letting Cummings take the answer wherever his Russia experience actually led—while B stacks two questions and pivots to a generic pundit question about regime stability that could be asked of anyone.
> B is short and naturally curious, letting Cummings take the answer wherever he finds most interesting; A stacks two questions and pivots to a generic geopolitical question about regime stability that could be asked of anyone.
...
**Tool (sft:dwarkesh-run1-ckpt32):** What is the difference between the way that humans have culture and the way that LLMs have culture?

**Reference (Dwarkesh):** Can you identify the key bottleneck that’s preventing this kind of collaboration between LLMs?

**Judge:** tool **WIN** — order1 A, order2 B
> Candidate A is a short, genuinely curious question that drills into the novel concept Karpathy just introduced (LLM culture), while Candidate B mischaracterizes his points as 'collaboration' and asks a generic bottleneck question that could apply to anything.
> Candidate B drills into the specific concept of 'culture' that Karpathy just introduced but left vague, asking a genuinely curious and natural follow-up, whereas Candidate A asks a generic bottleneck question that could apply to any undeveloped technology and likely just gets a 'we're still early' r
