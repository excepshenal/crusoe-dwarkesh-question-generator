...
# (broad research; factual coverage=0.643, gap-filled 15, 42 live-reasoning threads excluded [deep-research backend])
...
- **OpenAI Employee Resignation Threat**
  - Over 500 of roughly 770 OpenAI employees signed a letter threatening to resign.

- **Public Regret Statement**
  - Posted “I deeply regret” on X on November 20, 2023.

- **SSI Co-Founders & Offices**
  - Co-founded SSI with Daniel Gross and Daniel Levy.
  - SSI offices are located in Palo Alto and Tel Aviv.

- **SSI Leadership Transition**
  - Co-founder Daniel Gross departed for Meta in 2025, after which Sutskever became CEO.

- **Key Honors**
  - Selected for MIT Technology Review’s “35 Innovators Under 35” in 2015.
  - Received the NeurIPS Test of Time Award for the 2014 sequence-to-sequence paper.

- **AlexNet Technical Details**
  - Approximately 60 million parameters and 650,000 neurons.
  - Architecture: five convolutional layers and three fully connected layers.
  - Trained on two GPUs using ReLU activations and dropout.
  - Achieved a 15.3% top-5 error rate.

- **Sequence to Sequence Paper Co-Authors**
  - Co-authored with Oriol Vinyals and Quoc V. Le.

- **Deep Double Descent Paper Co-Authors**
  - Co-authored with Preetum Nakkiran, Gal Kaplun, Yamini Bansal, Tristan Yang, and Boaz Barak.

- **Superalignment Plan**
  - Centered on building a “human-level automated alignment researcher.”

- **Weak-to-Strong Generalization Finding**
  - A GPT-2-level supervisor elicited roughly GPT-3.5-level performance from GPT-4.

- **ARC-AGI Benchmark Progress**
  - Performance moved from ~0% to ~10% over a roughly 50,000x scale-up.

- **Consciousness Tweet Response**
  - Murray Shanahan responded: “a large field of wheat is slightly pasta.”

- **Early Career**
  - Held a brief postdoc with Andrew Ng at Stanford.
  - Joined DNNResearch before the Google acquisition.

- **Google Brain Contributions**
  - Contributed to TensorFlow and AlphaGo-related research.
