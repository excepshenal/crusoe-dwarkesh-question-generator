# Research dossier — Nat Friedman
# (broad research; factual coverage=0.541, gap-filled 45, 50 live-reasoning threads excluded [deep-research backend])
...
**Personal Background**
- Born August 6, 1977, in Charlottesville, Virginia.
- Graduated from St. Anne's-Belfield School in 1995.
- Earned a B.S. in Computer Science and Mathematics from MIT in 1999.
- Created the Linux IRC network 'LinuxNet' in 1996, where he met Miguel de Icaza.

**Ximian & Novell**
- Co-founded Ximian in 1999 (initially named 'International Gnome Support,' then 'Helix Code').
- Novell acquired Ximian in 2003.
- Served as Novell's Chief Technology and Strategy Officer for Open Source.

**Xamarin**
- Founded Xamarin in May 2011.

**GitHub Tenure**
- Microsoft acquired GitHub for $7.5 billion in June 2018.
- Assumed the CEO role on October 29, 2018.
- Shipped Actions, Sponsors, mobile apps, Codespaces, Advanced Security, a new CLI, and Copilot.
- Acquired npm and Semmle.
- Announced he would step down in November 2021, succeeded by COO Thomas Dohmke.

**Post-GitHub Investing & AI**
- Became a full-time investor with Daniel Gross, running AI Grant and NFDG.
- NFDG is reported as a ~$1.1 billion fund.
- Served on the board of the Arc Institute and advised Midjourney.
- Launched nat.dev in 2023.
- Declined to be considered for OpenAI's interim CEO role in November 2023.
- Joined Meta to co-lead Meta Superintelligence Labs in June 2025.

**Vesuvius Challenge**
- Launched on March 15, 2023, co-founded with Daniel Gross and Brent Seales.
- Offered more than $1M in prizes, with a personal sponsorship of $225,000 from Friedman.
- Technical pipeline: X-ray CT scanning, segmentation/virtual unwrapping, and ML ink detection.
- In October 2023, Luke Farritor read the first word ('purple' / ΠΟΡΦΥΡΑϹ) from inside an unopened scroll.
- A $700,000 Grand Prize was awarded in February 2024 to Youssef Nader, Luke Farritor, and Julian Schilliger.
- The winning team read 15+ columns / 2,000+ characters (~5% of a scroll), meeting the criteria of four passages of 140 characters at 85%+ recovery.
- The text was Epicurean philosophy on music, food, and pleasure, attributed to Philodemus.
- In May 2025, a $60,000 First Title Prize was won for recovering the title 'On Vices' by Philodemus.
- By 2025, the challenge reported awarding over $1,800,500 in total prizes.

**AI Grant & NFDG Operations**
- AI Grant funds startups with $250,000 on an uncapped SAFE plus infrastructure credits.
- Early portfolio companies include Perplexity, Cursor, Replicate, and Pika.
- NFDG built a private supercomputer called the Andromeda Cluster for portfolio companies.
- The Andromeda Cluster launched with 2,512 H100 GPUs and grew to ~3,200 H100s.

**Philosophy & Principles**
- Argues 'great individuals should be fully empowered to exercise their judgment' and 'smaller teams are better'.
- States 'the efficient market hypothesis is a lie'.
- States 'time is the denominator' and 'you can do more than you think'.
- States many tech companies are '2-10x overstaffed'.
- Investing posture is to 'raise the ceiling, not the floor,' concentrating on uncorrelated excellence.
- AI Grant operationalizes this by funding people with working demos rather than research papers.
- States 'the laws of physics are the only limit'.

**Copilot Legal Challenge**
- A class action lawsuit (*Doe v. GitHub*) was filed in November 2022 against GitHub, Microsoft, and OpenAI over Copilot.
- The lawsuit alleged Copilot reproduces licensed open-source code stripped of attribution, violating licenses and the DMCA.
- In May 2023, a court dismissed direct copyright claims but allowed breach-of-contract and DMCA claims to proceed.

**Open Source Ties**
- Early career was in open source (GNOME, Mono).
- At GitHub, launched GitHub Sponsors to fund maintainers directly.
