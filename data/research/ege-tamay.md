# Research dossier — Ege Erdil
# (broad research; factual coverage=0.527, gap-filled 26, 33 live-reasoning threads excluded [deep-research backend])
...
# Supplement: Ege Erdil — Missing Facts

## Interests & Background
- Self-described interests span mathematics, statistics, economics, and forecasting
- Maintains a public GitHub repository of scripts used to generate his Metaculus question forecasts

## AI Timeline Forecasts
- In a 2023 elicitation, Erdil's median for broader transformative AI was around 2073
- Later revised his full-remote-work AGI estimate from roughly 2064 down to around 2055
- Toby Ord's "Broad Timelines" essay cites Erdil (median 2045) as the canonical long-timelines anchor

## Core Posture on AI Progress
- Believes AGI is multiple decades away
- Thinks a fast software-only "intelligence explosion" is unlikely
- Nonetheless considers explosive economic growth plausible

## Views on AI Risk
- Believes the standard "alignment" framing of AI risk is largely mistaken

## Economic Estimates
- Projects roughly a $20 trillion annual wage bill for remotable global work as the prize
- Observes revenue per H100-equivalent is roughly in line with gross world product per capita (~$10K/year)
- Notes measured productivity has not improved since ChatGPT despite rising benchmark capability

## Computer-Vision Study Findings
- Attributed ImageNet progress to roughly ~45% algorithms, ~45% compute scaling, and ~10% data scaling
- Found >75% of algorithmic progress was "compute-augmenting"

## Data Bottleneck
- Partly relieved by multimodal data and synthetic data (400 trillion to 20 quadrillion effective tokens)

## Epoch's "Direct Approach" Framework
- Erdil's algorithmic-progress estimates feed into Epoch's "Direct Approach" framework
- The "Direct Approach" authors caution it is best treated as a theoretical framework rather than a precise forecast

## GATE Model
- Models computing improvement via two channels: hardware (compute per dollar) and software/algorithms (efficiency per computation)
- Headline implication: even with only ~30% of tasks automated, growth can exceed 20% annually
- Follow-up "AI and explosive growth redux" argues skeptics have not explained why observed investment is so low relative to apparent returns

## Critiques of Explosive Growth
- Will Rinehart argues explosive growth requires implausibly frictionless adoption, citing electricity and tractors
- Rinehart invokes Charles I. Jones, who shows explosive-growth models mathematically "break"
- Rinehart cites Korinek & Suh on the "race between automation and capital accumulation" and the "stuff problem"
- Daron Acemoglu has estimated AI's GDP impact at roughly one percentage point of cumulative growth over a decade

## Erdil & Besiroglu's Counterpoints
- Cite Aghion et al.'s result that automating R&D can produce growth acceleration or a singularity

## Bio Anchors Critique
- Using a Landauer-principle conversion, Erdil derived upper-bound estimates 4–6 orders of magnitude smaller than the Bio Anchors report's evolutionary anchor

## Mechanize
- Method: construct simulated digital offices where AI agents perform long-horizon jobs and are trained via RL
- Commentators including Zvi Mowshowitz and Fortune covered the Mechanize controversy
