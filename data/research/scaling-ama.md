# Research dossier — Trenton Bricken
# (broad research; factual coverage=0.446, gap-filled 41, 25 live-reasoning threads excluded [deep-research backend])
...
- Self-designed major at Duke University titled “Minds and Machines: Biological and Artificial Intelligence.”
- Attended Duke as a Robertson Scholar; graduated in May 2020.
- Worked in Michael Lynch’s lab at Duke.
- Worked in Debora Marks’s lab at Harvard Medical School.
- Entered the Systems Biology PhD program at Harvard, joining Gabriel Kreiman’s lab (affiliated with Harvard Medical School / Boston Children’s Hospital).
- PhD advisor was Gabriel Kreiman.
- PhD supported by an NSF Graduate Research Fellowship.
- Successfully defended his PhD on March 31, 2025.
- Was a visiting researcher at Berkeley’s Redwood Center for Theoretical Neuroscience.

**Key Publications & Research Details**
- “Sparse Distributed Memory is a Continual Learner” published at ICLR 2023, with Xander Davies, Deepak Singh, Dmitry Krotov, and Gabriel Kreiman.
- “Emergence of Sparse Representations from Noise” published at ICML 2023, with Rylan Schaeffer, Bruno Olshausen, and Gabriel Kreiman.
- The SDM paper’s code is on GitHub under TrentBrick/attention-approximates-sdm.
- The SDM paper was with advisor Cengiz Pehlevan and notes similar structure may appear in the hippocampus, dorsal cochlear nucleus, and olfactory system.
- “Towards Monosemanticity” published on the Transformer Circuits Thread in October 2023; used an L1 sparsity penalty plus reconstruction loss and an “autointerpretability” pipeline with an LLM to label features; stated the remaining obstacle to scaling “is engineering rather than science.”
- “Scaling Monosemanticity” published on the Transformer Circuits Thread in May 2024; trained SAEs on Claude 3 Sonnet’s middle-layer residual stream; had expansion ratios on the order of 83×, 333×, and 2,833×; demonstrated that features are causal levers (e.g., suppressing the “code error” feature made the model autocorrect flawed inputs; feature steering could make models write subtly incorrect code while concealing the error).
- On synthetic data, SAEs have been shown to recover as little as 9% of true features while achieving ~71% explained variance.

**Professional & Research Affiliations**
- Co-founder is Jared Kaplan.
- Contributed to IARPA’s Fun GCAT and DARPA’s Biostasis programs.

**Personal Interests & Portfolio**
- Maintains an analog film-photography portfolio.
- Lists backpacking among his interests.

**Stated Positions & Internal Tensions**
- Position: Mechanistic interpretability is a tractable path to AI safety.
- Imports specific brain models (SDM, the cerebellum, sparse coding) as scaffolding for hypotheses.
- Internal tension: The brain-AI analogy holds only under specific conditions.
- Internal tension: The SDM-attention correspondence describes structural resemblance, not mechanistic identity.
- Internal tension: A strongly reconstructing SAE can still miss most true features.
- Internal tension: Interpretability tools that reveal mechanisms also create new control surfaces.
- Internal tension: The recovered basis is partly a function of the method (dictionary size and L1 objective).
- External critics argue causal explanations diverge from correlational activation maps.
