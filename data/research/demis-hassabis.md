# Research dossier — Demis Hassabis
# (broad research; factual coverage=0.684, gap-filled 12, 27 live-reasoning threads excluded [deep-research backend])
...
- **Personal Background**
  - Born 27 July 1976 to a Greek Cypriot father and a Chinese Singaporean mother.
  - Achieved chess master status at age 13, with a peak Elo rating of 2300.

- **Early Games Industry Career**
  - Co-designed the game *Theme Park* at age 17.
  - Worked on the AI for *Black & White*.
  - Founded Elixir Studios.

- **Academic Research**
  - Completed a PhD in cognitive neuroscience at University College London (UCL).
  - Conducted research under Eleanor Maguire, focusing on episodic memory and the hippocampus.

- **DeepMind Acquisition**
  - DeepMind was acquired by Google for approximately £400 million (over $500 million).

- **Key Research Publication Milestones**
  - DQN: Published in *Nature*, 2015.
  - AlphaGo: Published in *Nature*, 2016.
  - AlphaGo Zero: Published in *Nature*, 2017.
  - AlphaZero: Published in *Science*, 2018.
  - AlphaFold2: Published in *Nature*, 2021.

- **2024 Nobel Prize**
  - Awarded the 2024 Nobel Prize in Chemistry, jointly with John Jumper, for protein structure prediction.

- **Counterarguments to AlphaFold 'Solving' Protein Folding**
  - Critics include George Rose, Ellen Zhong, and Lauren Porter, who argue that predicting a static structure does not fully capture the dynamic nature of protein folding.

- **Counterarguments to Neuroscience Inspiration for AI**
  - Critics note that modern architectures like Gemini are transformer-based, which have diverged significantly from direct biological inspiration.

- **Counterarguments on Scaling Limits**
  - Gary Marcus and an AAAI survey have presented arguments that scaling alone may hit fundamental limits and not lead to true understanding.

- **Internal Tensions from Google Brain Merger**
  - The merger with Google Brain increased commercial pressure, particularly on projects like Gemini, to deliver market-ready products.

- **Dissolution of External AI Ethics Board**
  - Google's external AI ethics board, the Advanced Technology External Advisory Council (ATEAC), was dissolved in 2019 shortly after its formation.

- **Gemini Model Development Bottlenecks**
  - Practical compute limits, such as fitting sufficient compute into a single data center and distributed computing challenges.
  - The need to adjust hyperparameters and the "recipe" at each new scale, as scaling laws do not work by simply repeating the same process.
