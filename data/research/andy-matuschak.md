# Research dossier — Andy Matuschak
# (broad research; factual coverage=0.574, gap-filled 43, 77 live-reasoning threads excluded [deep-research backend])
...
- **Working note title**: “Spaced repetition memory systems can be used to develop conceptual understanding” is an explicit working note title in Matuschak’s public system.
- **Polished essays vs. public notes**: His polished essays argue for rigor and completion; his public notes argue for visible, unfinished, perpetually-revised thinking, which he calls “work with the garage door up.”
- **Funding model as argument-in-action**: Matuschak concluded that transformative tools for thought are public goods that markets undersupply, so he funds his work through Patreon rather than a company or institution.
- **Self-critical admission in notes**: His own notes include the admission that “I can’t easily iterate on the design of the mnemonic medium by testing it on myself.”
- **Critique of books and critics’ response**: Matuschak’s critique of books targets detailed factual retention; critics point to forms of value (emotional, philosophical, dispositional) that his preferred medium and metrics are not designed to measure.
- **Patronage framing**: He frames membership not as a transaction but as patronage in the historical sense, describing each member as “like being a tiny grantmaker.”
- **Limits of spaced repetition**: His notes register the limits of spaced repetition for process knowledge and transfer learning, a standing tension in his work.
- **Reflective annual letters**: He has written reflective annual letters and a note on “Cultivating depth and stillness in research” that articulate the trade-offs of working without an institution.
- **Public notes as method and tension**: His public notes are deliberately exposed mid-thought and are simultaneously the method’s demonstration and an instance of a tension in his practice.
- **Central question**: His central question is how to develop genuinely transformative tools for thought — computational environments that would let people think thoughts otherwise impossible.
- **Evergreen note philosophy**: His note system embodies a distinct philosophy; he argues most note-taking fails because notes are treated as transient capture.
- **Evergreen note principles**: Evergreen notes are written to accumulate and evolve over time and follow three principles: atomic, concept-oriented, and densely linked.
- **Associative ontologies**: He prefers “associative ontologies to hierarchical taxonomies” and advises writing notes for oneself rather than an imagined audience.
- **Reframing note-taking**: The goal is not “better note-taking” but “better thinking,” with “evergreen note-writing as the fundamental unit of knowledge work.”
- **Critique of edtech**: His critique of edtech includes skepticism of engagement-optimized edtech and of MOOCs.
- **Rejection of authoritarian narratives**: He explicitly rejects “authoritarian” personalized-learning narratives that frame students as “defective,” favoring instead the “bicycle for the mind” framing.
- **Patreon launch and scale**: He set up the Patreon in 2019; by his account, within roughly two years his patrons had crowdfunded approximately the equivalent of a graduate-student fellowship.
- **Commitment to free public outputs**: He commits to making his primary outputs free and public.
- **Trade-offs of independence**: The trade-offs include maximal independence and long time horizons, set against isolation, the difficulty of sustaining a research community of one, and the risk that public-good outputs never find a path to scale.
- **Limits of conventional flashcard software**: His notes state that conventional flashcard software “is not designed to support process knowledge” and he flags genuine “uncertainty about whether the medium performs well” on transfer learning.
- **Tension between north star and mechanism**: His stated north star is understanding and transformative cognition, while the mechanism he has shipped and measured most rigorously is retention of detail.
- **Authoritarian premise of initial mnemonic medium**: He has called the initial mnemonic medium “implicitly authoritarian in premise” because the reader must surrender control over which prompts they collect.
- **Tension with learner agency**: This creates a tension with his stated commitment to learner agency and learning “in service of creation.”
- **Hostility to dominant edtech framings**: A consistent thread is hostility to dominant edtech framings; in “How Might We Learn?” he argues that meaningful learning historically happens inside immersive projects with real personal stakes.
- **Skepticism of chatbot tutors**: He is critical of the “chatbot tutor” vision, arguing that real tutors have contextual awareness, a relationship that shapes identity and disciplinary values, and shared purpose, whereas transactional, isolated chatbots create distance.
