...
# (broad research; factual coverage=0.639, gap-filled 13, 29 live-reasoning threads excluded [deep-research backend])
...
**Sholto Douglas**
- Spent a year studying at Tsinghua University in Beijing and in Hong Kong under a New Colombo Scholarship.
- Worked at McKinsey Digital.
- Co-author on 'Training Chain-of-Thought via Latent-Variable Inference'.

**Trenton Bricken**
- Completed his undergraduate degree at Duke University as a Robertson Scholar.
- Self-designed major titled 'Minds and Machines: Biological and Artificial Intelligence'.
- Supported by an NSF Graduate Research Fellowship.
- Was a visiting researcher at Berkeley's Redwood Center for Theoretical Neuroscience.
- Co-author on 'Using Dictionary Learning Features as Classifiers' and 'Building and Evaluating Alignment Auditing Agents'.

**Gary Marcus & Scaling Skepticism**
- Gary Marcus is a prominent scaling skeptic who argues pure scaling will not deliver robust reasoning.

**Documented Criticisms of Sparse Autoencoders (SAEs)**
- Incomplete coverage.
- Irreducible reconstruction error.
- Weak validation from papers like 'Sparse Autoencoders Can Interpret Randomly Initialized Transformers'.

**Factual Internal Tensions**
- Douglas frames clever priors as losing to scale, while his own most-cited paper is domain-specific systems engineering.
- The interpretability program demonstrably does not recover all of the model's computation.

**SDM-Attention Correspondence**
- Holds only 'under certain data conditions'.
